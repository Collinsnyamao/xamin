...
@NgModule({
  declarations: [PortfolioTwoComponent, PortfolioThreeComponent, PortfolioFourComponent, PortfolioFiveComponent, NoSpaceComponent, NoSpaceMasonryComponent, MasonryTwoComponent, MasonryThreeComponent],
  imports: [
    CommonModule,
    XaminModule,
