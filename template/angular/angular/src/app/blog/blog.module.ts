...
@NgModule({
  declarations: [BlogListComponent, BlogOneColumnComponent, BlogTwoColumnComponent, BlogThreeColumnComponent, BlogRightOneGridComponent, BlogRightTwoGridComponent, BlogLeftTwoGridComponent, BlogLeftOneGridComponent],
  imports: [
    CommonModule,
