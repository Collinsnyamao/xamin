...
//Components
import Banner from '../../components/service-section/managed-analytics/banner';
import LeftPanel from '../../components/service-section/managed-analytics/left-panel';
import RightPanel from '../../components/service-section/managed-analytics/right-panel';

import Footer from '../../components/service-section/managed-analytics/footer';
...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            activeMenu:['/services','/managed-analytics'],
        };
    }
