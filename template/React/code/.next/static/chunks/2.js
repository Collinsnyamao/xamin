 ...
 */
!function (t, e) {
   true ? module.exports = e(function () {
    try {
  ...
  function i(t) {
    var e = function () {
      for (var t = {}, e = _Object$keys(n), i = e.length, a = 0; a < i; a++) {
        t[e[a]] = {
          distance: -1,
          parent: null
        };
    ...
    for (e[t].distance = 0; i.length;) {
      for (var a = i.pop(), r = _Object$keys(n[a]), o = r.length, s = 0; s < o; s++) {
        var l = r[s],
            u = e[l];
  ...
  _Object$keys(n).forEach(function (t) {
    o[t] = {}, _Object$defineProperty(o[t], "channels", {
      value: n[t].channels
    }), _Object$defineProperty(o[t], "labels", {
      value: n[t].labels
    });

    var e = function (t) {
      for (var e = i(t), n = {}, a = _Object$keys(e), o = a.length, s = 0; s < o; s++) {
        var l = a[s];
  ...
  function h(t) {
    if (t) {
      ...
      if (e) {
        ...
        return [m(_parseInt(e[1]), 0, 360), m(_parseFloat(e[2]), 0, 100), m(_parseFloat(e[3]), 0, 100), m(isNaN(n) ? 1 : n, 0, 1)];
      }
    }
  }
  ...
  var _,
    ...
    each: function each(t, e, n, i) {
      ...
      } else if (w.isObject(t)) for (r = (o = _Object$keys(t)).length, a = 0; a < r; a++) {
        e.call(n, t[o[a]], o[a]);
      }
    },
    ...
    merge: function merge(t, e, n) {
      ...
      for (i = (n = n || {}).merger || w._merger, a = 0; a < u; ++a) {
        if (e = l[a], w.isObject(e)) for (s = 0, o = (r = _Object$keys(e)).length; s < o; ++s) {
          i(r[s], t, e, n);
        }
      }
  ...
  var X = G,
    ...
    onAnimationComplete: null
      ...
      Z = K;
  _Object$defineProperty(K.prototype, "animationObject", {
    get: function get() {
      return this;
    }
  }), _Object$defineProperty(K.prototype, "chartInstance", {
    get: function get() {
      return this.chart;
    },
    set: function set(t) {
  ...
  var $ = {
    ...
    advance: function advance() {
      for (var t, e, n, i, a = this.animations, r = 0; r < a.length;) {
        e = (t = a[r]).chart, n = t.numSteps, i = Math.floor((_Date$now() - t.startTime) / t.duration * n) + 1, t.currentStep = Math.min(i, n), V.callback(t.render, [e, t], e), V.callback(t.onAnimationProgress, [t], e), t.currentStep >= n ? (V.callback(t.onAnimationComplete, [t], e), e.animating = !1, a.splice(r, 1)) : ++r;
      }
    }
  },
      J = V.options.resolve,
  ...
  V.extend(et.prototype, {
    ...
    buildOrUpdateElements: function buildOrUpdateElements() {
      var t,
          ...
          i = n.getDataset(),
          a = i.data || (i.data = []);
      n._data !== a && (n._data && tt(n._data, n), a && _Object$isExtensible(a) && (e = n, (t = a)._chartjs ? t._chartjs.listeners.push(e) : (_Object$defineProperty(t, "_chartjs", {
        configurable: !0,
        enumerable: !1,
        value: {
          listeners: [e]
    ...
    _resolveDataElementOptions: function _resolveDataElementOptions(t, e) {
      ...
      return p.cacheable && (n._cachedDataOpts = _Object$freeze(f)), f;
    },
  ...
  V.extend(Qe.prototype, {
    construct: function construct(t, e) {
      ...
      var i = Fe.acquireContext(t, e),
          ...
          r = a && a.height,
          o = a && a.width;
      n.id = V.uid(), n.ctx = i, n.canvas = a, n.config = e, n.width = o, n.height = r, n.aspectRatio = r ? o / r : null, n.options = e.options, n._bufferedRender = !1, n._layers = [], n.chart = n, n.controller = n, Qe.instances[n.id] = n, _Object$defineProperty(n, "data", {
        get: function get() {
  ...
  var Kn = V._deprecated,
      ...
      $n = V.valueOrDefault,
      Jn = _Number$MIN_SAFE_INTEGER || -9007199254740991,
      Qn = _Number$MAX_SAFE_INTEGER || 9007199254740991,
      ti = {
    millisecond: {
      common: !0,
      size: 1,
  ...
  var di = xn.extend({
    ...
    determineDataLimits: function determineDataLimits() {
      ...
      m.length && (c = Math.min(c, m[0]), f = Math.max(f, m[m.length - 1])), g.length && (g = n > 1 ? function (t) {
        ...
        return r;
      }(g).sort(ni) : g.sort(ni), c = Math.min(c, g[0]), f = Math.max(f, g[g.length - 1])), c = si(s, ii(d)) || c, f = si(s, ai(d)) || f, c = c === Qn ? +u.startOf(_Date$now(), h) : c, f = f === Jn ? +u.endOf(_Date$now(), h) + 1 : f, s.min = Math.min(c, f), s.max = Math.max(c + 1, f), s._table = [], s._timestamps = {
        data: g,
        datasets: p,
        labels: m
      };
  ...
  for (var Ni in Li.filler = Oi, Li.legend = Ri, Li.title = zi, tn.helpers = V, function () {
    ...
    V.where = function (t, e) {
    ...
    }, V.EPSILON = _Number$EPSILON || 1e-14, V.splineCurveMonotone = function (t) {
      var e,
          n,
          i,
          a,
    ...
    }, V.requestAnimFrame = false ? undefined : window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
      ...
      var l = _parseFloat(V.getStyle(r, "padding-left")),
          u = _parseFloat(V.getStyle(r, "padding-top")),
          d = _parseFloat(V.getStyle(r, "padding-right")),
          h = _parseFloat(V.getStyle(r, "padding-bottom")),
      ...
      return (e = V.getStyle(t, e)).indexOf("%") > -1 ? n * _parseInt(e, 10) / 100 : _parseInt(e, 10);
