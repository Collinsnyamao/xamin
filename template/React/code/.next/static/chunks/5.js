...
/***/ "./static/assets/revslider/js/rs6.min.js":
/*!***********************************************!*\
  !*** ./static/assets/revslider/js/rs6.min.js ***!
  \***********************************************/
/*! no static exports found */
...
!function (e, t) {
  ...
  var i;
  e.fn.extend({
    revolution: function revolution(a) {
      return this.each(function () {
        ...
        e.fn.revolution[s] = V(a), (i = e.fn.revolution)[s].c = e(this), i[s].cpar = i[s].c.parent(), i[s].canvas = i[s].c.find("rs-slides"), i[s].stopAfterLoops != t && i[s].stopAfterLoops > -1 ? i[s].looptogo = i[s].stopAfterLoops : i[s].looptogo = "disabled", i[s].BUG_safari_clipPath = "Safari" === i.get_browser() && i.get_browser_version() > "12", i[s].BUG_ie_clipPath = "Edge" === i.get_browser() || "IE" === i.get_browser(), i[s].anyid = [], i[s].indexhelper = 0, i[s].level = 0, i[s].rtl = e("body").hasClass("rtl"), i[s].minHeight = i[s].minHeight != t && "" !== i[s].minHeight ? _parseInt(i[s].minHeight, 0) : 0, r(s), "hero" == i[s].sliderType && i[s].c.find("rs-slide").each(function (t) {
          t > 0 && e(this).remove();
    ...
    revcurrentslide: function revcurrentslide() {
      if (i[e(this)[0].id] !== t) return _parseInt(i[e(this)[0].id].pr_active_key, 0) + 1;
    },
    ...
    callContWidthManager: function callContWidthManager(e) {
      g(e);
    },
    revModal: function revModal(a, r) {
      if (a !== t && i[a] !== t) switch (r.mode) {
        ...
        case "close":
          C(a), document.body.style.overflow = window.overscrollhistory, i[a].modal.bodyclass !== t && i[a].modal.bodyclass.length >= 0 && document.body.classList.remove(i[a].modal.bodyclass), punchgs.TweenMax.to(i[a].modal.bg, 2, {
            display: "none",
            opacity: 0,
            ease: punchgs.Power3.easeInOut
    ...
    revToResp: function revToResp(e, i, a, r) {
      if ((e = e === t ? a : e) !== t) {
        if (r = r === t ? "," : r, "boolean" != typeof e && ("object" != typeof e || _Array$isArray(e))) {
          try {
            e = e.replace(/[[\]]/g, "").replace(/\'/g, "").split(r);
          } catch (e) {}

          for (e = _Array$isArray(e) ? e : [e]; e.length < i;) {
    ...
    updateVisibleArea: function updateVisibleArea(a) {
      for (var r in i[a].viewPort.visible_area = i.revToResp(i[a].viewPort.visible_area, i[a].rle, "200px"), i[a].viewPort.vaType = new Array(4), i[a].viewPort.visible_area) {
        i[a].viewPort.visible_area.hasOwnProperty(r) && (e.isNumeric(i[a].viewPort.visible_area[r]) && (i[a].viewPort.visible_area[r] += "%"), i[a].viewPort.visible_area[r] !== t && (i[a].viewPort.vaType[r] = i[a].viewPort.visible_area[r].indexOf("%") >= 0 ? "%" : "px"), i[a].viewPort.visible_area[r] = _parseInt(i[a].viewPort.visible_area[r], 0), i[a].viewPort.visible_area[r] = "%" == i[a].viewPort.vaType[r] ? i[a].viewPort.visible_area[r] / 100 : i[a].viewPort.visible_area[r]);
      }
    },
    fontLoaded: function fontLoaded(e) {
    ...
    callBackHandling: function callBackHandling(t, a, r) {
    ...
    isSafari11: function isSafari11() {
      return "safari" === e.trim(i.get_browser().toLowerCase()) && _parseFloat(i.get_browser_version()) >= 11;
    },
    ...
    getComingSlide: function getComingSlide(a, r) {
      var o = i[a].pr_next_key !== t ? i[a].pr_next_key : i[a].pr_processing_key !== t ? i[a].pr_processing_key : i[a].pr_active_key,
          s = 0;
      if (s = 0, i[a].pr_active_slide !== t && i[a].pr_active_slide.hasClass("not-in-nav") && (o = i[a].pr_lastshown_key), r !== t && e.isNumeric(r) || r !== t && r.match(/to/g)) s = 1 === r || -1 === r ? _parseInt(o, 0) + r < 0 ? i[a].slideamount - 1 : _parseInt(o, 0) + r >= i[a].slideamount ? 0 : _parseInt(o, 0) + r : (r = e.isNumeric(r) ? r : _parseInt(r.split("to")[1], 0)) < 0 ? 0 : r > i[a].slideamount - 1 ? i[a].slideamount - 1 : r;else if (r) for (var n in i[a].slides) {
    ...
    callingNewSlide: function callingNewSlide(e, t, a) {
      var r = i.getComingSlide(e, t);
      i[e].pr_next_key = r.nindex, i[e].sdir = i[e].pr_next_key < i[e].pr_active_key ? 1 : 0, i[e].ctNavElement ? i[e].ctNavElement = !1 : i[e].c.trigger("revolution.nextslide.waiting"), (r.aindex === i[e].pr_next_key && r.aindex === i[e].pr_lastshown_key || i[e].pr_next_key !== r.aindex && -1 != i[e].pr_next_key) && P(e, a);
    },
    ...
    setSize: function setSize(a, r) {
      var o,
          s = _parseInt(i[a].top_outer || 0) + _parseInt(i[a].bottom_outer || 0),
          n = "carousel" == i[a].sliderType ? _parseInt(i[a].carousel.padding_top || 0, 0) : 0,
          l = "carousel" == i[a].sliderType ? _parseInt(i[a].carousel.padding_bottom || 0, 0) : 0,
          d = 0,
          c = 0,
          p = 0,
      ...
      if (i[a].minHeight = i[a].minHeight === t ? 0 : i[a].minHeight || 0, i[a].paddings = i[a].paddings === t ? {
        top: _parseInt(i[a].cpar.css("paddingTop"), 0) || 0,
        bottom: _parseInt(i[a].cpar.css("paddingBottom"), 0) || 0
      } : i[a].paddings, i[a].rowzones && i[a].rowzones.length > 0) {
        if (i[a].rowzones[u] !== t) for (o = 0; o < i[a].rowzones[u].length; o++) {
          d += i[a].rowzones[u][o][0].offsetHeight;
        }
        if (h !== u) for (o = 0; o < i[a].rowzones[h].length; o++) {
          c += i[a].rowzones[h][o][0].offsetHeight;
        }
      }

      if (i[a].srowzones && i[a].srowzones.length > 0) for (o = 0; o < i[a].srowzones.length; o++) {
      ...
      if (g = 0 !== i[a].maxHeight ? Math.min(i[a].maxHeight, g) : g, "fullwidth" != i[a].sliderLayout || i[a].autoHeight || punchgs.TweenMax.set(i[a].c, {
        ...
        i[a].fullScreenOffset != t && !e.isNumeric(i[a].fullScreenOffset) && i[a].fullScreenOffset.split("%").length > 1 ? f -= e(window).height() * _parseInt(i[a].fullScreenOffset, 0) / 100 : i[a].fullScreenOffset != t && i[a].fullScreenOffset.length > 0 && e.isNumeric(_parseInt(i[a].fullScreenOffset, 0)) && (f -= _parseInt(i[a].fullScreenOffset, 0)), i[a].height = Math.max(d, Math.max(f - s, i[a].minHeight)), h !== u && (i[a].currentSlideHeight = Math.max(c, Math.max(f - s, i[a].minHeight)), i[a].slides[h].style.maxHeight = i[a].currentSlideHeight !== i[a].height ? i[a].currentSlideHeight + "px" : "none"), i[a].cpar.height(i[a].height), i[a].c.css({
          height: "100%"
        });
      ...
      })), i[a].middleZones && i[a].middleZones.length > 0 && i[a].middleZones[u] !== t) for (o = 0; o < i[a].middleZones[u].length; o++) {
        i[a].middleZones[u][o].style.top = Math.round(b / 2 - i[a].middleZones[u][o].offsetHeight / 2) + "px";
      }
      if (i[a].smiddleZones && i[a].smiddleZones.length > 0) for (o = 0; o < i[a].smiddleZones.length; o++) {
        i[a].smiddleZones[o].style.top = Math.round(b / 2 - i[a].smiddleZones[o].offsetHeight / 2) + "px";
      }
      y(a);
    },
    enterInViewPort: function enterInViewPort(a) {
      i[a].waitForCountDown && (Q(a), i[a].waitForCountDown = !1), i[a].waitForFirstSlide && (P(a), i[a].waitForFirstSlide = !1, setTimeout(function () {
    ...
    leaveViewPort: function leaveViewPort(a) {
    ...
    revCheckIDS: function revCheckIDS(a, r) {
      if (r.dataset.idcheck === t) {
        for (; -1 != e.inArray(r.id, i[a].anyid);) {
          console.log("Warning !! Double Id in Slider " + a + ": " + r.id), r.id = r.id + "_" + Math.round(9999 * Math.random());
        }
  ...
  var a = i.is_mobile(),
    ...
    l && l.length && e.each(l, function (e, a) {
      n < a && (0 == o || o > _parseInt(a)) && (r = _parseInt(a), i[t].level = e, o = _parseInt(a)), n > a && o < a && (o = _parseInt(a), s = e);
    ...
    for (var d in l) {
      l.hasOwnProperty(d) && (l[d].dataset !== t && "on" == l[d].dataset.hsom && a ? l[d].classList.add("removeslidenow") : (l[d].dataset === t || !l[d].dataset.invisible && 1 != l[d].dataset.invisible ? i[r].slideamount++ : l[d].classList.add("not-in-nav"), i[r].realslideamount++, l[d].dataset !== t && (l[d].dataset.originalindex = i[r].realslideamount, l[d].dataset.origindex = i[r].realslideamount - 1)));
    }
    ...
    if (i[r] !== t) {
      ...
      for (var n in i[r].slides = i[r].canvas[0].getElementsByTagName("rs-slide"), i[r].thumbs = new Array(i[r].slides.length), i[r].slots = 4, i[r].firststart = 1, i[r].loadqueue = [], i[r].syncload = 0, i.updateDimensions(r), i[r].slides) {
        if (i[r].slides.hasOwnProperty(n)) {
          ...
          if (i[r].thumbs[n] = h, d.dataset.link != t || d.dataset.linktoslide !== t) {
            ...
            if (w != t && "no" != w && "next" != w && "prev" != w) for (var _ in i[r].slides) {
              i[r].slides.hasOwnProperty(_) && _parseInt(i[r].slides[_].dataset.origindex, 0) + 1 == d.dataset.linktoslide && (w = i[r].slides[_].dataset.key);
            }
            e(d).append('<rs-layer class="rs-layer slidelink" style="z-index:' + ("back" === d.dataset.seoz ? 0 : "front" === d.dataset.seoz ? 60 : d.dataset.seoz !== t ? _parseInt(d.dataset.seoz, 0) : 100) + ';" dataxy="x:c;y:c" data-dim="w:100%;h:100%" data-basealign="slide"' + ("no" == w ? "" : "  data-actions='" + ("scroll_under" === w ? "o:click;a:scrollbelow;offset:100px;" : "prev" === w ? "o:click;a:jumptoslide;slide:prev;d:0.2;" : "next" === w ? "o:click;a:jumptoslide;slide:next;d:0.2;" : "o:click;a:jumptoslide;slide:" + w + ";d:0.2;") + "'") + " data-frame_1='e:Power3.easeInOut;st:100;sp:100' data-frame_999='e:Power3.easeInOut;o:0;st:w;sp:100'><a " + ("slide" != y ? ' target="' + (d.dataset.target || "_self") + '" href="' + y + '"' : "") + "><span></span></a></rs-layer>");
          }
        }
      }
      ...
      }), "auto" == i[r].sliderLayout || 0 != i[r].c.closest("rs-fullwidth-wrap").length || "fullscreen" === i[r].sliderLayout && 1 == i[r].disableForceFullWidth) i[r].topc = i[r].cpar;else {
      ...
      if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && i[r].c.css({
        ...
        i[r].c[0].classList.add("revslider-initialised"), i[r].c[0].id = i[r].c[0].id === t ? "revslider-" + Math.round(1e3 * Math.random() + 5) : i[r].c[0].id, i.revCheckIDS(r, i[r].c[0]), i[r].origcd = _parseInt(i[r].duration, 0), i[r].scrolleffect._L = [], i[r].sbas = i[r].sbas === t ? {} : i[r].sbas, i[r].layers = i[r].layers || {}, i[r].sortedLayers = i[r].sortedLayers || {}, i[r].c.detach(), i[r].c.find("rs-layer, rs-row, rs-column, rs-group,  rs-bgvideo, .rs-layer").each(function () {
          var a,
              o,
              s = e(this),
              n = s.data();
          if (n.startclasses = this.className, n.startclasses = n.startclasses === t || null === n.startclasses ? "" : n.startclasses, n.animationonscroll = !!i[r].sbtimeline.set && i[r].sbtimeline.layers, n.animationonscroll = !0 === n.animationonscroll || "true" == n.animationonscroll, n.filteronscroll = !!i[r].scrolleffect.set && i[r].scrolleffect.layers, n.pxundermask = n.startclasses.indexOf("rs-pxmask") >= 0 && "off" !== i[r].parallax.type && n.startclasses.indexOf("rs-pxl-") >= 0, n.noPevents = n.startclasses.indexOf("rs-noevents") >= 0, n.sba) for (var l in a = n.sba.split(";")) {
            a.hasOwnProperty(l) && ("t" == (o = a[l].split(":"))[0] && (n.animationonscroll = o[1], "false" == o[1] && (n.animOnScrollForceDisable = !0)), "e" == o[0] && (n.filteronscroll = o[1]), "so" == o[0] && (n.scrollBasedOffset = _parseInt(o[1]) / 1e3));
          }
          ...
          if ("true" != n.animationonscroll && 1 != n.animationonscroll || (n.startclasses += " rs-sba", s[0].className += " rs-sba"), n.startclasses.indexOf("rs-layer-static") >= 0 && i.handleStaticLayers && i.handleStaticLayers(s, r), "RS-BGVIDEO" !== s[0].tagName) {
            if (s[0].classList.add("rs-layer"), "column" === n.type && (n.columnwidth = "33.33%", n.verticalalign = "top", n.column !== t)) for (var d in a = n.column.split(";")) {
              a.hasOwnProperty(d) && ("w" === (o = a[d].split(":"))[0] && (n.columnwidth = o[1]), "a" === o[0] && (n.verticalalign = o[1]));
            }
            ...
            for (var y in "row" === n.type || "column" === n.type || "group" === n.type ? (s[0].classList.remove("tp-resizeme"), "column" === n.type && (n.width = "auto", s[0].group = "row", punchgs.TweenMax.set(s, {
              width: "auto"
            }), n.filteronscroll = !1)) : (f = "display:" + ("inline-block" === s[0].style.display ? "inline-block" : "block") + ";", s.closest("rs-column").length > 0 ? (s[0].group = "column", n.filteronscroll = !1) : s.closest("rs-group-wrap").length > 0 && (s[0].group = "group", n.filteronscroll = !1)), n.wrpcls !== t && (h = h + " " + n.wrpcls), n.wrpid !== t && (m = 'id="' + n.wrpid + '"'), n.maskinuse = !1, n) {
        ...
        if (T.length < 9 && T.split("slide").length > 1 && -1 == T.indexOf("slider")) {
          var L = _parseInt(T.split("slide")[1], 0);

          e.isNumeric(_parseInt(L, 0)) && ((L = _parseInt(L, 0)) < 1 && (L = 1), L > i[r].slideamount && (L = i[r].slideamount), i[r].startWithSlide = L - 1);
        }

        var R = _parseInt(i[r].spinner.replace("spinner", ""), 10);

        if (isNaN(R) || R < 6) i[r].loader = e('<rs-loader class="' + i[r].spinner + '"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></rs-loader>');else {
          var M,
              O = i[r].spinnerclr || "#ffffff",
              C = '<div class="rs-spinner-inner"';
          if (7 === R) -1 !== O.search("#") ? (M = O.replace("#", ""), M = "rgba(" + _parseInt(M.substring(0, 2), 16) + ", " + _parseInt(M.substring(2, 4), 16) + ", " + _parseInt(M.substring(4, 6), 16) + ", ") : -1 !== O.search("rgb") && (M = O.substring(O.indexOf("(") + 1, O.lastIndexOf(")")).split(",")).length > 2 && (M = "rgba(" + M[0].trim() + ", " + M[1].trim() + ", " + M[2].trim() + ", "), M && "string" == typeof M && (C += ' style="border-top-color: ' + M + "0.65); border-bottom-color: " + M + "0.15); border-left-color: " + M + "0.65); border-right-color: " + M + '0.15)"');else 12 === R && (C += ' style="background:' + O + '"');
          C += ">";

          for (var j = [10, 0, 4, 2, 5, 9, 0, 4, 4, 2][R - 6], A = 0; A < j; A++) {
            A > 0 && (C += " "), C += '<span style="background:' + O + '"></span>';
          }

          C += "</div>", i[r].loader = e('<rs-loader class="' + i[r].spinner + '">' + C + "</div></rs-loader>");
        }
        ...
        i[r].inviewport = !1, H != t && H.enable && i.scrollTicker && i.scrollTicker(r), i[r].slides.each(function (t) {
          ...
          !H.enable || H.enable && i[r].inviewport || H.enable && !i[r].inviewport && "wait" !== H.outof ? P(r) : (i[r].c.addClass("tp-waitforfirststart"), i[r].waitForFirstSlide = !0, H.presize && (i[r].pr_next_slide = e(i[r].slides[0]), I(i[r].pr_next_slide[0], r, 0, !0), S(i[r].pr_next_slide.find(".tp-layers"), r, function () {
    ...
    i[a].autoHeight && punchgs.TweenMax.set([i[a].c, i[a].cpar], {
      ...
      overflow: "visible"
    }).wrap("<rs-carousel-wrap></rs-carousel-wrap>"), i[a].cpar.prepend("<rs-carousel-space></rs-carousel-space>").append("<rs-carousel-space></rs-carousel-space>"), i.prepareCarousel(a)), i[a].startWithSlide = i[a].startWithSlide === t ? t : _parseInt(i[a].startWithSlide) + 1, i[a].cpar.css({
      overflow: "visible"
    ...
    if (i[a] !== t) if (clearTimeout(i[a].waitWithSwapSlide), i[a].pr_processing_key === t) {
      ...
      !0 === i[a].onlyPreparedSlide && (i[a].onlyPreparedSlide = !1), i[a].pr_processing_key = i[a].pr_next_key, delete i[a].pr_next_key, i[a].pr_next_slide !== t && i[a].pr_next_slide[0] !== t && i[a].pr_next_slide[0].dataset.hal !== t && (i[a].pr_next_slide[0].dataset.sofacounter = i[a].pr_next_slide[0].dataset.sofacounter == t ? 1 : _parseInt(i[a].pr_next_slide[0].dataset.sofacounter, 0) + 1), i[a].stopLoop && i[a].pr_processing_key == i[a].lastslidetoshow - 1 && (i[a].c.find("rs-progress").css({
        visibility: "hidden"
    ...
    if (i[r] !== t) {
      if (i[r].pr_active_slide = e(i[r].slides[i[r].pr_active_key]), i[r].pr_next_slide = e(i[r].slides[i[r].pr_processing_key]), i[r].pr_active_bg = i[r].pr_active_slide.find("rs-sbg-wrap"), i[r].pr_next_bg = i[r].pr_next_slide.find("rs-sbg-wrap"), i[r].tonpause = !1, clearTimeout(i[r].loadertimer), i[r].loader !== t && i[r].loader.css({
        ...
        slider: r,
        slideIndex: _parseInt(i[r].pr_active_key, 0) + 1,
        slideLIIndex: i[r].pr_active_key,
        nextSlideIndex: _parseInt(i[r].pr_processing_key, 0) + 1,
      ...
      }), i[r].transition = 1, i[r].stopByVideo = !1, i[r].pr_next_slide[0] !== t && i[r].pr_next_slide[0].dataset.duration != t && "" != i[r].pr_next_slide[0].dataset.duration ? i[r].duration = _parseInt(i[r].pr_next_slide[0].dataset.duration, 0) : i[r].duration = i[r].origcd, i[r].pr_next_slide[0] === t || "true" != i[r].pr_next_slide[0].dataset.ssop && !0 !== i[r].pr_next_slide[0].dataset.ssop ? i[r].ssop = !1 : i[r].ssop = !0, i[r].sbtimeline.set && i[r].sbtimeline.fixed && i.updateFixedScrollTimes(r), i[r].c.trigger("nulltimer"), i[r].sdir = i[r].pr_processing_key < i[r].pr_active_key ? 1 : 0, "arrow" == i[r].sc_indicator && (0 == i[r].pr_active_key && i[r].pr_processing_key == i[r].slideamount - 1 && (i[r].sdir = 1), i[r].pr_active_key == i[r].slideamount - 1 && 0 == i[r].pr_processing_key && (i[r].sdir = 0)), i[r].lsdir = i[r].sdir, i[r].pr_active_key != i[r].pr_processing_key && 1 != i[r].firststart && "carousel" !== i[r].sliderType && i.removeTheLayers && i.removeTheLayers(i[r].pr_active_slide, r), i[r].pr_next_slide.hasClass("rs-pause-timer-once") || i[r].pr_next_slide.hasClass("rs-pause-timer-always") ? i[r].stopByVideo = !0 : i[r].c.trigger("restarttimer"), i[r].pr_next_slide.removeClass("rs-pause-timer-once"), "carousel" == i[r].sliderType) i[r].mtl = new punchgs.TimelineLite(), i.prepareCarousel(r, i[r].mtl), A(r), i[r].transition = 0;else {
        ...
        i[r].pr_next_slide[0].dataset.ntrid = "on" == i[r].pr_next_slide[0].dataset.rndtrans ? Math.round(80 * Math.random()) : _parseInt(i[r].pr_next_slide[0].dataset.ntrid, 0) + 1 || 0, i[r].pr_next_slide[0].dataset.ntrid = s.transition === t || i[r].pr_next_slide[0].dataset.ntrid == s.transition.length ? 0 : i[r].pr_next_slide[0].dataset.ntrid, i.animateSlide({
          animation: s,
  ...
  var A = function A(r) {
    if (i[r] !== t && (i[r].firstSlideAvailable === t && (i[r].firstSlideAvailable = !0, i.showFirstTime !== t && i.showFirstTime(r)), "carousel" === i[r].sliderType || (punchgs.TweenMax.to(i[r].pr_next_bg.find("rs-sbg"), .001, {
          ...
          if (r === t) {
            ...
            for (var s in o) {
              if (o.hasOwnProperty(s)) {
                ...
                switch (n[0]) {
                  case "s":
                    r.s = _parseInt(n[1], 0) / 1e3;
                    break;

                  case "e":
                    r.e = _parseInt(n[1], 0) / 1e3;
                    break;
            ...
            r.r = "unlimited" === r.r ? -1 : _parseInt(r.r, 0), i[e].sloops[a] = r, r.key = a;
          }
      ...
      }(r), i[r].c.find(".active-rs-slide").removeClass("active-rs-slide"), e(i[r].slides[i[r].pr_active_key]).addClass("active-rs-slide"), i[r].pr_active_bg.data("pztl") != t && (i[r].pr_active_bg.data("pztl").reverse(), i[r].pr_active_bg.data("pztl").timeScale(25)), i[r].pr_next_bg.data("panzoom") !== t && (i[r].pr_next_bg.data("pztl") != t ? (i[r].pr_next_bg.data("pztl").timeScale(1), i[r].pr_next_bg.data("pztl").play()) : i.startPanZoom(i[r].pr_next_bg, r)), i[r].pr_next_slide.find("rs-bgvideo").each(function (t) {
      ...
      var o = {
        ...
        prevSlideIndex: i[r].pr_lastshown_key !== t && _parseInt(i[r].pr_lastshown_key, 0) + 1,
        prevSlideLIIndex: i[r].pr_lastshown_key !== t && _parseInt(i[r].pr_lastshown_key, 0),
        prevSlide: i[r].pr_lastshown_key !== t && i[r].slides[i[r].pr_lastshown_key]
      };
    ...
    return e.charAt(0).toUpperCase() + e.slice(1);
      ...
      V = function V(i) {
    return function (i) {
      for (var a in i.minHeight = i.minHeight !== t ? "none" === i.minHeight || "0" === i.minHeight || "0px" === i.minHeight || "" == i.minHeight || " " == i.minHeight ? 0 : _parseInt(i.minHeight, 0) : 0, i.maxHeight = "none" === i.maxHeight || "0" === i.maxHeight ? 0 : _parseInt(i.maxHeight, 0), i.carousel.maxVisibleItems = i.carousel.maxVisibleItems < 1 ? 999 : i.carousel.maxVisibleItems, i.carousel.vertical_align = "top" === i.carousel.vertical_align ? "0%" : "bottom" === i.carousel.vertical_align ? "100%" : "50%", i.carousel.space = _parseInt(i.carousel.space, 0), i.carousel.maxOpacity = _parseInt(i.carousel.maxOpacity, 0), i.carousel.maxRotation = _parseInt(i.carousel.maxRotation, 0), i.carousel.minScale = _parseInt(i.carousel.minScale, 0), i.navigation.maintypes = ["arrows", "tabs", "thumbnails", "bullets"], i.navigation.maintypes) {
        i.navigation.maintypes.hasOwnProperty(a) && i.navigation[i.navigation.maintypes[a]] !== t && (i.navigation[i.navigation.maintypes[a]].animDelay = _parseInt(i.navigation[i.navigation.maintypes[a]].animDelay, 0) / 1e3, i.navigation[i.navigation.maintypes[a]].animSpeed = _parseInt(i.navigation[i.navigation.maintypes[a]].animSpeed, 0) / 1e3);
      }

      if (e.isNumeric(i.scrolleffect.tilt) || -1 !== i.scrolleffect.tilt.indexOf("%") && (i.scrolleffect.tilt = _parseInt(i.scrolleffect.tilt)), i.scrolleffect.tilt = i.scrolleffect.tilt / 100, i.navigation.thumbnails.position = "outer-horizontal" == i.navigation.thumbnails.position ? "bottom" == i.navigation.thumbnails.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.thumbnails.position ? "left" == i.navigation.thumbnails.h_align ? "outer-left" : "outer-right" : i.navigation.thumbnails.position, i.navigation.tabs.position = "outer-horizontal" == i.navigation.tabs.position ? "bottom" == i.navigation.tabs.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.tabs.position ? "left" == i.navigation.tabs.h_align ? "outer-left" : "outer-right" : i.navigation.tabs.position, i.sbtimeline.speed = _parseInt(i.sbtimeline.speed, 0) / 1e3 || .5, !0 === i.sbtimeline.set && !0 === i.sbtimeline.fixed && "auto" !== i.sliderLayout ? (i.sbtimeline.fixStart = _parseInt(i.sbtimeline.fixStart), i.sbtimeline.fixEnd = _parseInt(i.sbtimeline.fixEnd)) : i.sbtimeline.fixed = !1, i.startDelay = _parseInt(i.startDelay, 0) || 0, i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_under != t && (i.navigation.arrows.hide_under = _parseInt(i.navigation.arrows.hide_under)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_under != t && (i.navigation.bullets.hide_under = _parseInt(i.navigation.bullets.hide_under)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_under != t && (i.navigation.thumbnails.hide_under = _parseInt(i.navigation.thumbnails.hide_under)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_under != t && (i.navigation.tabs.hide_under = _parseInt(i.navigation.tabs.hide_under)), i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_over != t && (i.navigation.arrows.hide_over = _parseInt(i.navigation.arrows.hide_over)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_over != t && (i.navigation.bullets.hide_over = _parseInt(i.navigation.bullets.hide_over)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_over != t && (i.navigation.thumbnails.hide_over = _parseInt(i.navigation.thumbnails.hide_over)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_over != t && (i.navigation.tabs.hide_over = _parseInt(i.navigation.tabs.hide_over)), i.lazyloaddata !== t && i.lazyloaddata.length > 0 && i.lazyloaddata.indexOf("-") > 0) {
        var r = i.lazyloaddata.split("-");

        for (i.lazyloaddata = r[0], a = 1; a < r.length; a++) {
          i.lazyloaddata += W(r[a]);
        }
      }

      return i.duration = _parseInt(i.duration), i;
    }(e.extend(!0, {
      sliderType: "standard",
      sliderLayout: "auto",
      dottedOverlay: "none",
  ...
  var moduleEnterLeaveActions = function moduleEnterLeaveActions(e) {
    !_R[e].moduleActionsPrepared && _R[e].c[0].getElementsByClassName("rs-on-sh").length > 0 && (_R[e].c.on("tp-mouseenter", function () {
      ...
      if ("none" !== i && i !== undefined) {
        if ((i = _R[e].slides[i].dataset.key) !== undefined && _R[e].layers[i]) for (t in _R[e].layers[i]) {
                ...
                switch (event.action) {
                  case "openmodal":
                    if (event.modalslide = event.modalslide === undefined ? 0 : event.modalslide, window.RS_60_MODALS === undefined || -1 == jQuery.inArray(event.modal, window.RS_60_MODALS)) {
                      ...
                      jQuery.ajax({
                        ...
                        dataType: "json",
                        data: data,
                        success: function success(e, t, i) {
                  ...
                  case "scrollto":
                    ...
                    var doc = jQuery(document),
                        off = "scrollbelow" === event.action ? (getOffContH(_R[id].fullScreenOffsetContainer) || 0) - (_parseInt(event.offset, 0) || 0) || 0 : 0 - (_parseInt(event.offset, 0) || 0),
                  ...
                  case "jumptoslide":
                    switch (event.slide.toLowerCase()) {
                      ...
                      default:
                        var ts = jQuery.isNumeric(event.slide) ? _parseInt(event.slide, 0) : event.slide;
    ...
    for (var i in e) {
      if (e.hasOwnProperty(i)) {
        ...
        switch (a[0]) {
          ...
          case "d":
            t.delay = _parseInt(a[1], 0) / 1e3, t.delay = "NaN" === t.delay || isNaN(t.delay) ? 0 : t.delay;
            break;
  ...
  jQuery.extend(!0, t, {
    prepareCarousel: function prepareCarousel(e, o, n, l) {
    ...
    carouselToEvalPosition: function carouselToEvalPosition(e, i) {
      var o = t[e].carousel;
    ...
    organiseCarousel: function organiseCarousel(e, i, a, r) {
      ...
      t[e].slides && jQuery.each(t[e].slides, function (r, l) {
        ...
        if ((a && Math.abs(g) < c || 0 === g) && (c = Math.abs(g), o.focused = r), h.width = o.slide_width, h.x = 0, h.transformPerspective = 1200, h.transformOrigin = "50% " + o.vertical_align, o.fadeout) {
          if (o.vary_fade) h.autoAlpha = 1 - Math.abs(o.maxOpacity / 100 / Math.ceil(o.maxVisibleItems / f) * g);else switch (o.horizontal_align) {
            case "center":
        ...
        void 0 !== o.minScale && o.minScale > 0 && (o.vary_scale ? h.scale = 1 - Math.abs(o.minScale / 100 / Math.ceil(o.maxVisibleItems / f) * g) : h.scale = g >= 1 || g <= -1 ? 1 - o.minScale / 100 : (100 - o.minScale * Math.abs(g)) / 100, p = g * (h.width - h.width * h.scale) / 2), void 0 !== o.maxRotation && 0 != Math.abs(o.maxRotation) && (o.vary_rotation ? (h.rotationY = Math.abs(o.maxRotation) - Math.abs((1 - Math.abs(1 / Math.ceil(o.maxVisibleItems / f) * g)) * o.maxRotation), h.autoAlpha = Math.abs(h.rotationY) > 90 ? 0 : h.autoAlpha) : h.rotationY = g >= 1 || g <= -1 ? o.maxRotation : Math.abs(g) * o.maxRotation, h.rotationY = g < 0 ? -1 * h.rotationY : h.rotationY), h.x = -1 * o.space * g, h.left = Math.floor(h.left), h.x = Math.floor(h.x), void 0 !== h.scale && (h.x = h.x + p), h.zIndex = Math.round(100 - Math.abs(5 * g)), h.force3D = !0, h.transformStyle = "3D" != t[e].parallax.type && "3d" != t[e].parallax.type ? "flat" : "preserve-3d", punchgs.TweenLite.set(l, h);
  ...
  var i = function i(e) {
    ...
    void 0 === i.wrap && function (e) {
      ...
      })), void 0 !== i.border_radius && _parseInt(i.border_radius, 0) > 0 && punchgs.TweenLite.set(t[e].c.find("rs-slide"), {
    ...
    var n = {},
        l = _r ? punchgs.Power2.easeOut : s.easing;
    n.from = 0, n.to = s.slide_offset_target, o = void 0 === o ? s.speed / 1e3 : o, 0 !== (o = _r ? o * (Math.abs(n.to) / s.wrapwidth) : o) && o < .1 && Math.abs(n.to) > 25 && (o = .3), void 0 !== s.positionanim && s.positionanim.pause(), s.positionanim = punchgs.TweenLite.to(n, o, {
      from: n.to,
      onUpdate: function onUpdate() {
        s.slide_offset = s.slide_globaloffset + n.from, s.slide_offset = t.simp(s.slide_offset, s.maxwidth), t.organiseCarousel(e, i, !1, !1);
      },
      onComplete: function onComplete() {
        s.slide_globaloffset = s.infinity ? t.simp(s.slide_globaloffset + s.slide_offset_target, s.maxwidth) : s.slide_globaloffset + s.slide_offset_target, s.slide_offset = t.simp(s.slide_offset, s.maxwidth), t.organiseCarousel(e, i, !1, !0), void 0 !== s.focused && _r && t.callingNewSlide(e, jQuery(t[e].slides[s.focused]).data("key"), !0), "carousel" !== t[e].sliderType || t[e].carousel.fadein || (punchgs.TweenLite.to(t[e].canvas, 1, {
          scale: 1,
          opacity: 1
        }), t[e].carousel.fadein = !0), t[e].c.trigger("revolution.slide.carouselchange", {
          slider: e,
          slideIndex: _parseInt(t[e].pr_active_key, 0) + 1,
          slideLIIndex: t[e].pr_active_key,
          slide: t[e].pr_next_slide,
          currentslide: t[e].pr_next_slide,
          prevSlideIndex: void 0 !== t[e].pr_lastshown_key && _parseInt(t[e].pr_lastshown_key, 0) + 1,
          prevSlideLIIndex: void 0 !== t[e].pr_lastshown_key && _parseInt(t[e].pr_lastshown_key, 0),
  ...
  jQuery.extend(!0, i, {
      ...
      for (var n in i[o]._L = void 0 === i[o]._L ? {} : i[o]._L, i[o].layers[s]) {
        if (i[o].layers[s].hasOwnProperty(n)) {
          ...
          if (void 0 === c.dataset.initialised) {
            ...
            }), void 0 !== g.border) for (t in g.border = g.border.split(";"), g.bordercolor = "transparent", g.border) {
            ...
            if (void 0 !== g.dim) for (t in g.dim = g.dim.split(";"), g.dim) {
            ...
            if (void 0 !== g.xy) for (t in g.xy = g.xy.split(";"), g.xy) {
            ...
            if (!g._isnotext && void 0 !== g.text) for (t in g.text = g.text.split(";"), g.text) {
            ...
            if (void 0 !== g.flcr) for (t in g.flcr = g.flcr.split(";"), g.flcr) {
            ...
            if (void 0 !== g.padding) for (t in g.padding = g.padding.split(";"), g.padding) {
            ...
            if (void 0 !== g.margin) for (t in g.margin = g.margin.split(";"), g.margin) {
            ...
            if (void 0 !== g.spike && (g.spike = I(g.spike)), void 0 !== g.corners) for (t in r = g.corners.split(";"), g.corners = {}, r) {
              r.hasOwnProperty(t) && r[t].length > 0 && (g.corners[r[t]] = jQuery("<" + r[t] + "></" + r[t] + ">"), g.c.append(g.corners[r[t]]));
            }
            g.textalign = u(g.textalign), g.vbility = i.revToResp(g.vbility, i[o].rle, !0), g.hoffset = i.revToResp(g.hoffset, i[o].rle, 0), g.voffset = i.revToResp(g.voffset, i[o].rle, 0), g.x = i.revToResp(g.x, i[o].rle, "l"), g.y = i.revToResp(g.y, i[o].rle, "t"), k(h, 0, o), c.dataset.initialised = !0;
          }
            ...
            if (0 == g.vbility[i[o].levelForced] || "f" == g.vbility[i[o].levelForced] || m < i[o].hideLayerAtLimit && "on" == g.layeronlimit || m < i[o].hideAllLayerAtLimit ? g.p[0].classList.add("rs-layer-hidden") : g.p[0].classList.remove("rs-layer-hidden"), g.poster = null == g.poster && void 0 !== g.thumbimage ? g.thumbimage : g.poster, "image" === g.layertype) {
              if ("cover-proportional" === g.img.data("c")) {
                ...
                var L = "auto" !== g.width[i[o].level] || isNaN(g.width[i[o].level]) && g.width[i[o].level].indexOf("%") >= 0 ? "100%" : "auto",
                    z = "auto" !== g.height[i[o].level] || isNaN(g.height[i[o].level]) && g.height[i[o].level].indexOf("%") >= 0 ? "100%" : "auto";
                punchgs.TweenMax.set(g.img, {
                  width: L,
                  height: z
                });
              ...
              var M = g.width[i[o].level],
                  O = g.height[i[o].level];
              M = "auto" === M ? M : !jQuery.isNumeric(M) && M.indexOf("%") > 0 ? g._incolumn || g._ingroup ? "100%" : "grid" === g.basealign ? i[o].gridwidth[i[o].level] * i[o].bw : m : "off" !== g.rsp_bd ? _parseFloat(M) * i[o].bw + "px" : _parseFloat(M) + "px", O = "auto" === O ? O : !jQuery.isNumeric(O) && O.indexOf("%") > 0 ? "grid" === g.basealign ? i[o].gridheight[i[o].level] * i[o].bw : v : "off" !== g.rsp_bd ? _parseFloat(O) * i[o].bh + "px" : _parseFloat(O) + "px";
              var C = T(h, o);

              if (g._incolumn && "100%" === M && "auto" === O && void 0 !== g.ytid) {
                ...
                width: M,
                height: O
              }), (0 == g.html5vid && !S || 1 != g.forcecover && !h.hasClass("rs-fsv") && !S) && (g.media.width(M), g.media.height(O)), g._ingroup && null != M && !jQuery.isNumeric(M) && M.indexOf("%") > 0 && punchgs.TweenMax.set([g.lp, g.p, g.m], {
                minWidth: M
              });
            }
            g._slidelink || R(h, o, 0, g.rsp_bd), "on" === g.rsp_ch && "row" !== g.type && "column" !== g.type && "group" !== g.type && h.find("*").each(function () {
              var e = jQuery(this);
              null == this.dataset || this.dataset.stylerecorder || k(e, "rekursive", o), R(e, o, "rekursive", g.rsp_bd);
            });
          }
          ...
          if ("preset" !== e.mode) {
            if (g.eow = h.outerWidth(!0), g.eoh = h.outerHeight(!0), ("text" === g.type || "button" === g.type) && void 0 !== g.corners) {
              for (r in g.corners) {
                if (g.corners.hasOwnProperty(r)) {
                  ...
                  g.corners[r].css("border" + (j ? "Right" : "Left"), "0px solid transparent"), g.corners[r].css("border" + ("rs-fcrt" == r || "rs-bcr" == r ? "Bottom" : "Top") + "Color", g.bgcol);
                }
              }
            ...
            var A = "on" === g.rsp_o ? _parseInt(g.voffset[i[o].level], 0) * i[o].bw : _parseInt(g.voffset[i[o].level], 0),
                Q = "on" === g.rsp_o ? _parseInt(g.hoffset[i[o].level], 0) * i[o].bw : _parseInt(g.hoffset[i[o].level], 0),
    ...
    animcompleted: function animcompleted(e, t) {
    ...
    handleStaticLayers: function handleStaticLayers(e, t) {
      ...
      if (void 0 !== e[0].dataset.onslides) {
        ...
        for (var s in o) {
          if (o.hasOwnProperty(s)) {
            var n = o[s].split(":");
            "s" === n[0] && (a = _parseInt(n[1], 0)), "e" === n[0] && (r = _parseInt(n[1], 0));
          }
        }
      }
    ...
    animateTheLayers: function animateTheLayers(e) {
      ...
      if (i[t].layers = i[t].layers || {}, i[t].layers[a] = void 0 === i[t].layers[a] ? x(jQuery(i[t].slides[e.slide]), "rs-layer") : i[t].layers[a], i[t].layers["static"] = void 0 === i[t].layers["static"] ? x(jQuery(i[t].c.find("rs-static-layers")), "rs-layer") : i[t].layers["static"], i[t].sbas[a] = void 0 === i[t].sbas[a] ? x(jQuery(i[t].slides[e.slide]), "rs-sba") : i[t].sbas[a], i.updateDimensions(t), void 0 !== a && i[t].layers[a] && i.initLayer({
        ...
        skey: "static",
        mode: "updateposition"
      })), void 0 !== a && i[t].layers[a]) for (var o in i[t].layers[a]) {
      ...
      if (i[t].layers["static"]) for (var o in i[t].layers["static"]) {
    ...
    removeTheLayers: function removeTheLayers(e, t, a) {
    ...
    renderLayerAnimation: function renderLayerAnimation(e) {
      ...
      if ("preset" !== e.mode || !0 === u.frames.frame_1.timeline.waitoncall || void 0 !== u.scrollBasedOffset || !0 === u.forceRender) {
        if ("trigger" == e.mode && (u.triggeredFrame = e.frame), u._isstatic) {
          var x = "carousel" === i[c].sliderType && void 0 !== i[c].carousel.oldfocused ? i[c].carousel.oldfocused : void 0 === i[c].pr_lastshown_key ? 1 : _parseInt(i[c].pr_lastshown_key, 0) + 1,
              k = "carousel" === i[c].sliderType ? void 0 === i[c].pr_next_key ? 0 === x ? 1 : x : _parseInt(i[c].pr_next_key, 0) + 1 : void 0 === i[c].pr_processing_key ? x : _parseInt(i[c].pr_processing_key, 0) + 1,
              ...
              if ("frame_999" !== I || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                ...
                var S = u.frames[I],
                  ...
                  target: "frommask"
                    ...
                    W = H.ease;
                "block" === j.type && (j.ft[0].background = S.sfx.fxc, O.add(punchgs.TweenMax.fromTo(j.bmask_in, A / 2, j.ft[0], j.ft[1], 0)), O.add(punchgs.TweenMax.fromTo(j.bmask_in, A / 2, j.ft[1], j.t, A / 2)), "frame_0" === I || "frame_1" === I ? N.opacity = 0 : "frame_999" === I && O.add(C.staggerFromTo(P, .05, {
                  autoAlpha: 1
                }, {
                  autoAlpha: 0,
                  delay: A / 2
                ...
                var V = 0;
                if (void 0 !== u.splitText && !1 !== u.splitText) for (var Y in t) {
                  if (void 0 === S[t[Y]] || u.quickRendering) u.fff ? O.add(C.fromTo(u.splitText[t[Y]], A, {
                    immediateRender: !1,
                    color: N.color
                  }, {
                    color: H.color
                  }, 0), 0) : O.add(C.to(u.splitText[t[Y]], A, {
                    color: H.color
                  }, 0), 0);else {
                    ...
                    delete Z.dir, Z.data = {
                      splitted: !0
                    }, void 0 !== q && delete q.dir, u.fff ? O.add(C.staggerFromTo(F, A, q, Z, u.frames[I].split ? Q : 0, 0), 0) : O.add(C.staggerTo(F, A, Z, u.frames[I].split ? Q : 0, 0), 0), V = F.length > V ? F.length : V;
                  }
                }
                A += u.frames[I].split ? Q * V : 0, u.pxundermask || void 0 !== D && (void 0 !== M && "hidden" === M.mask.overflow || "hidden" === S.mask.overflow) ? (O.add(punchgs.TweenMax.to(u.m, .001, {
                  overflow: "hidden"
                }), 0), "column" === u.type && O.add(punchgs.TweenMax.to(u.cbgmask, .001, {
                  overflow: "hidden"
                }), 0), u.btrans && (B && (B.rotationX = u.btrans.rX, B.rotationY = u.btrans.rY, B.rotationZ = u.btrans.rZ, B.opacity = u.btrans.o), D.rotationX = u.btrans.rX, D.rotationY = u.btrans.rY, D.rotationZ = u.btrans.rZ, D.opacity = u.btrans.o), u.fff ? O.add(punchgs.TweenMax.fromTo([u.m, u.cbgmask], A, jQuery.extend(!0, {}, B), jQuery.extend(!0, {}, D)), .001) : O.add(punchgs.TweenMax.to([u.m, u.cbgmask], A, jQuery.extend(!0, {}, D)), .001)) : void 0 !== u.btrans ? O.add(punchgs.TweenMax.to(u.m, .001, {
                  x: 0,
                  y: 0,
                  filter: "none",
                  opacity: u.btrans.o,
                  ...
                  overflow: "visible"
                }), 0), H.force3D = "auto", u.fff ? (H.visibility = "visible", void 0 !== u.cbg && O.fromTo(u.cbg, A, N, H, 0), i[c].BUG_safari_clipPath && (N.clipPath || H.clipPath || u.spike) && (N.z && _parseInt(N.z, 10) || (N.z = -1e-4), H.z && _parseInt(H.z, 10) || (H.z = 0)), void 0 !== u.cbg && "column" === u.type ? O.fromTo(P, A, a(N), a(H), 0) : O.fromTo(P, A, N, H, 0)) : (void 0 !== u.cbg && O.to(u.cbg, A, H, 0), !i[c].BUG_safari_clipPath || !H.clipPath && !u.spike || H.z && _parseInt(H.z, 10) || (H.z = 0 - .01 * Math.random()), void 0 !== u.cbg && "column" === u.type ? O.to(P, A, a(H), 0) : O.to(P, A, H, 0)), void 0 !== W && "object" != typeof W && W.indexOf("SFXBounce") >= 0 && O.to(P, A, {
                  scaleY: .5,
                  scaleX: 1.3,
                  ease: H.ease + "-squash",
                  transformOrigin: "bottom"
                }, 1e-4);
                var U = "trigger" !== e.mode && (!0 !== b && "skiprest" !== b || "rebuild" !== e.mode) || e.frame === I || void 0 === S.timeline.start || !jQuery.isNumeric(S.timeline.start) ? "+=0" === S.timeline.start || void 0 === S.timeline.start ? "+=0.005" : _parseInt(S.timeline.start, 0) / 1e3 : "+=" + _parseInt(S.timeline.startRelative, 0) / 1e3;
        ...
        if (void 0 !== u.frames.loop) {
          var G = u.frames.loop.frame_0,
            ...
            yoyo: u.frames.loop.timeline.yoyo_filter
              ...
              ae = _parseInt(u.frames.loop.timeline.speed, 0) / 1e3,
              re = _parseInt(u.frames.loop.timeline.start) / 1e3 || 0,
              oe = re + .2;
          ...
          if (K.add($, 0), K.add(ee, 0), K.add(te, 0), K.add(ie, 0), J.originX = G.originX, J.originY = G.originY, J.originZ = G.originZ, u.frames.loop.timeline.curved) {
            var se = _parseInt(u.frames.loop.timeline.radiusAngle, 0) || 0,
                ne = [{
              x: (G.x - G.xr) * i[c].bw,
              y: 0,
              z: (G.z - G.zr) * i[c].bw
            ...
            for (var de in ne) {
              ne.hasOwnProperty(de) && (le.values[de] = ne[se], se = ++se == ne.length ? 0 : se);
            }
            ...
            u.timeline.fromTo(u.lp, .2, {
              ...
              "-webkit-filter": "blur(" + _parseInt(G.blur, 0) + "px) grayscale(" + _parseInt(G.grayscale, 0) + "%) brightness(" + _parseInt(G.brightness, 0) + "%)",
              filter: "blur(" + _parseInt(G.blur, 0) + "px) grayscale(" + _parseInt(G.grayscale, 0) + "%) brightness(" + _parseInt(G.brightness, 0) + "%)",
            ...
            opacity: G.opacity,
            "-webkit-filter": "blur(" + _parseInt(G.blur || 0, 0) + "px) grayscale(" + _parseInt(G.grayscale || 0, 0) + "%) brightness(" + _parseInt(G.brightness || 100, 0) + "%)",
            filter: "blur(" + _parseInt(G.blur || 0, 0) + "px) grayscale(" + _parseInt(G.grayscale || 0, 0) + "%) brightness(" + _parseInt(G.brightness || 100, 0) + "%)"
          }, re), $.to(u.lp, u.frames.loop.timeline.yoyo_move ? ae / 2 : ae, {
            x: J.x * i[c].bw,
            y: J.y * i[c].bw,
            z: J.z * i[c].bw,
          ...
          pe = 0 === pe ? 1e-5 : pe, u.hoverlistener || (u.hoverlistener = !0, jQuery(document).on("mouseenter mousemove", ("column" === u.type ? "#" + u.cbg[0].id + "," : "") + "#" + u.c[0].id, function (e) {
            if (("mousemove" !== e.type || !0 !== u.ignoremousemove) && u.readyForHover) {
              if (u.ignoremousemove = !0, u.elementHovered = !0, u.hovertimeline || (u.hovertimeline = new punchgs.TimelineMax()), u.hovertimeline.to([u.m, u.cbgmask], pe, {
                ...
                var t = _Array$isArray(u.svgHTemp.fill) ? u.svgHTemp.fill[i[c].level] : u.svgHTemp.fill;
        ...
        if (z || (u.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? e.frame : u.lastRequestedMainFrame), void 0 !== e.totime ? u.tSTART = e.totime : void 0 !== f && void 0 === e.frame ? u.tSTART = f : void 0 !== e.frame ? u.tSTART = e.frame : u.tSTART = 0, 0 === u.tSTART && void 0 === u.startedAnimOnce && void 0 === u.leftstage && void 0 === u.startedAnimOnce && !0 === u.hideonfirststart && "preset" === e.mode && (i[c]._L[d[0].id].p[0].classList.add("rs-forcehidden"), u.hideonfirststart = !1), "frame_999" !== u.tSTART && "frame_999" !== u.triggeredFrame || !u.leftstage && void 0 !== u.startedAnimOnce) {
          if ("true" != u.animationonscroll && 1 != u.animationonscroll ? u.timeline.play(u.tSTART) : u.timeline.time(u.tSTART), jQuery.inArray(u.type, ["group", "row", "column"]) >= 0 && !0 === e.updateChildren) {
            if (void 0 === u.childrenJS) for (var Y in u.childrenJS = {}, i[c]._L) {
              void 0 !== i[c]._L[Y]._lig && void 0 !== i[c]._L[Y]._lig[0] && i[c]._L[Y]._lig[0].id === d[0].id && i[c]._L[Y]._lig[0].id !== i[c]._L[Y].c[0].id && (u.childrenJS[i[c]._L[Y].c[0].id] = i[c]._L[Y].c);
            }
            var ue = void 0 === e.totime ? void 0 !== u.frames[e.frame].timeline.startAbsolute ? _parseInt(u.frames[e.frame].timeline.startAbsolute, 0) / 1e3 : void 0 !== u.frames[e.frame].timeline.start ? jQuery.isNumeric(u.frames[e.frame].timeline.start) ? _parseInt(u.frames[e.frame].timeline.start, 0) / 1e3 : e.totime : .001 : e.totime;

            for (var Y in u.childrenJS) {
              u.childrenJS.hasOwnProperty(Y) && i.renderLayerAnimation({
  ...
  var a = function a(e) {
    ...
    if ("column" === i[e.id]._L[e.L[0].id].type || "row" === i[e.id]._L[e.L[0].id].type || "group" === i[e.id]._L[e.L[0].id].type) {
      ...
      r++, r = i[e.id]._L[e.L[0].id].ford.length > r ? i[e.id]._L[e.L[0].id].ford[r] : a, void 0 !== i[e.id]._L[e.L[0].id].frames[r] && void 0 !== i[e.id]._L[e.L[0].id].frames[a] && (i[e.id]._L[e.L[0].id].timezone = {
        from: _parseInt(i[e.id]._L[e.L[0].id].frames[a].timeline.startAbsolute, 0),
        to: _parseInt(i[e.id]._L[e.L[0].id].frames[r].timeline.startAbsolute, 0)
      });
    }
    ...
    if (-1 !== e.search("deg,")) {
      var t = e.split("deg,")[0];
      if (-1 !== t.search(/\(/)) return _parseInt(t.split("(")[1], 10);
    }
    ...
    for (var n in a) {
      if (a.hasOwnProperty(n)) if (a[n] = "object" == typeof a[n] ? a[n][i[e.id].level] : a[n], "inherit" === a[n] || "delay" === n || "direction" === n || "use" === n) delete a[n];else if ("originX" === n || "originY" === n || "originZ" === n) r[n] = a[n], delete a[n];else if (jQuery.isNumeric(a[n], 0)) a[n] = f(a[n], e.frame.reverse, e.target, n, e.id, e.id);else if ("r" === a[n][0] && "a" === a[n][1] && "random" !== a[n]) {
        a[n] = a[n].replace("ran(", "").replace(")", "");
        var l = a[n].indexOf("%") >= 0 ? "%" : "",
            d = a[n].split("|");

        if (d[0] = _parseFloat(d[0]), d[1] = _parseFloat(d[1]), void 0 !== e.splitAmount && e.splitAmount > 1) {
    ...
    if (a.transformOrigin = r.originX + " " + r.originY + " " + r.originZ, !i[e.id].BUG_ie_clipPath && void 0 !== a.clip && void 0 !== t.clipPath && t.clipPath.use) {
      var u = "rectangle" == t.clipPath.type,
          h = _parseInt(a.clip, 0),
          g = 100 - _parseInt(a.clipB, 0),
          m = Math.round(h / 2);
    ...
    return "mask" !== e.target && (void 0 === e.frame || void 0 === e.frame.filter && !e.forcefilter || (a["-webkit-filter"] = "blur(" + (null == e.frame.filter ? 0 : e.frame.filter.blur || 0) + "px) grayscale(" + (null == e.frame.filter ? 0 : e.frame.filter.grayscale || 0) + "%) brightness(" + (null == e.frame.filter ? 100 : e.frame.filter.brightness || 100) + "%)", a.filter = "blur(" + (null == e.frame.filter ? 0 : e.frame.filter.blur || 0) + "px) grayscale(" + (null == e.frame.filter ? 0 : e.frame.filter.grayscale || 0) + "%) brightness(" + (null == e.frame.filter ? 100 : e.frame.filter.brightness || 100) + "%)"), jQuery.inArray(e.source, ["chars", "words", "lines"]) >= 0 && (void 0 !== e.frame[e.source].blur || e.forcefilter) && (a["-webkit-filter"] = "blur(" + (_parseInt(e.frame[e.source].blur, 0) || 0) + "px) grayscale(" + (_parseInt(e.frame[e.source].grayscale, 0) || 0) + "%) brightness(" + (_parseInt(e.frame[e.source].brightness, 0) || 100) + "%)", a.filter = "blur(" + (_parseInt(e.frame[e.source].blur, 0) || 0) + "px) grayscale(" + (_parseInt(e.frame[e.source].grayscale, 0) || 0) + "%) brightness(" + (_parseInt(e.frame[e.source].brightness, 0) || 100) + "%)")), a.ease = void 0 !== a.ease ? a.ease : void 0 === a.ease && void 0 !== e.ease || void 0 !== a.ease && void 0 !== e.ease && "inherit" === a.ease ? e.ease : e.frame.timeline.ease, a.ease = void 0 === a.ease || "default" === a.ease ? punchgs.Power3.easeInOut : a.ease, a;
  },
      v = function v(e) {
    var t;

    for (var i in e) {
      "string" == typeof e[i] && e[i].indexOf("|") >= 0 && ((t = void 0 === t ? {} : t)[i] = e[i].replace("[", "").replace("]", "").split("|"), delete e[i]);
    }
    ...
    for (var p in r = void 0 === r ? "transform" : r, "loop" === o ? (c.autoRotate = !1, c.yoyo_filter = !1, c.yoyo_rotate = !1, c.yoyo_move = !1, c.yoyo_scale = !1, c.curved = !1, c.curviness = 2, c.ease = "Linear.easeNone", c.speed = 1e3, c.st = 0, l.x = 0, l.y = 0, l.z = 0, l.xr = 0, l.yr = 0, l.zr = 0, l.scaleX = 1, l.scaleY = 1, l.originX = "50%", l.originY = "50%", l.originZ = "0", l.rotationX = "0deg", l.rotationY = "0deg", l.rotationZ = "0deg") : (c.speed = 300, a ? c.ease = "default" : l.ease = "default"), "sfx" === o && (l.fxc = "#ffffff"), e = e.split(";")) {
      if (e.hasOwnProperty(p)) {
        ...
        switch (u[0]) {
          ...
          case "cp":
            l.clip = _parseInt(u[1], 0);
            break;

          case "cpb":
            l.clipB = _parseInt(u[1], 0);
            break;
          ...
          case "x":
            l.x = "reverse" === o ? "t" === u[1] || !0 === u[1] || "true" == u[1] : "loop" === o ? _parseInt(u[1], 0) : i.revToResp(u[1], i[t].rle);
            break;

          case "y":
            l.y = "reverse" === o ? "t" === u[1] || !0 === u[1] || "true" == u[1] : "loop" === o ? _parseInt(u[1], 0) : i.revToResp(u[1], i[t].rle);
            break;

          case "z":
            l.z = "loop" === o ? _parseInt(u[1], 0) : i.revToResp(u[1], i[t].rle);
            break;
          ...
          case "xR":
            l.xr = _parseInt(u[1], 0);
            break;

          case "yR":
            l.yr = _parseInt(u[1], 0);
            break;

          case "zR":
            l.zr = _parseInt(u[1], 0);
            break;

          case "blu":
            "loop" === o ? l.blur = _parseInt(u[1], 0) : d.blur = _parseInt(u[1], 0);
            break;

          case "gra":
            "loop" === o ? l.grayscale = _parseInt(u[1], 0) : d.grayscale = _parseInt(u[1], 0);
            break;

          case "bri":
            "loop" === o ? l.brightness = _parseInt(u[1], 0) : d.brightness = _parseInt(u[1], 0);
            break;

          case "sp":
            c.speed = _parseInt(u[1], 0);
            break;

          case "d":
            l.delay = _parseInt(u[1], 0);
            break;

          case "crns":
            c.curviness = _parseInt(u[1], 0);
            break;
      ...
      if (e.ford.hasOwnProperty(r)) {
        ...
        if (e[s]) {
          if (a[s] = b(e[s], t, !0), void 0 !== a[s].bgcolor && (e.bgcolinuse = !0), i[t].BUG_ie_clipPath && void 0 !== e.clipPath && e.clipPath.use && void 0 !== a[s].transform.clip) {
            var n = "rectangle" === e.clipPath.type ? 100 - _parseInt(a[s].transform.clip) : 100 - Math.min(100, 2 * _parseInt(a[s].transform.clip));
      ...
      for (var r in l) {
        if (l.hasOwnProperty(r)) {
          ...
          switch (d[0]) {
            ...
            case "r":
              e.layerLoop.repeat = _parseInt(d[1], 0);
              break;
    ...
    for (var r in (e.loop_0 || e.loop_999) && (a.loop = b(e.loop_999, t, !0, "frame_999", "loop"), a.loop.frame_0 = b(e.loop_0 || "", t, !1, void 0, "loop").transform), a.frame_0.transform.opacity = void 0 === a.frame_0.transform.opacity ? 0 : a.frame_0.transform.opacity, a.frame_1.transform.opacity = void 0 === a.frame_1.transform.opacity ? 1 : a.frame_1.transform.opacity, a.frame_999.transform.opacity = void 0 === a.frame_999.transform.opacity ? "inherit" : a.frame_999.transform.opacity, a.frame_0.transform.transformPerspective = void 0 === a.frame_0.transform.transformPerspective ? "600px" : a.frame_0.transform.transformPerspective, e.clipPath && e.clipPath.use && (a.frame_0.transform.clip = void 0 === a.frame_0.transform.clip ? 100 : _parseInt(a.frame_0.transform.clip), a.frame_1.transform.clip = void 0 === a.frame_1.transform.clip ? 100 : _parseInt(a.frame_1.transform.clip)), e.resetfilter = !1, a) {
    ...
    for (var r in e) {
      if (e.hasOwnProperty(r) && "loop" !== r && "frame_hover" !== r) {
        for (t in i.transform) {
          i.transform.hasOwnProperty(t) && (i.transform[t] = void 0 === e[r].transform[t] ? "frame_0" === r ? window.rdF0.transform[t] : "frame_1" === r ? window.rdF1.transform[t] : i.transform[t] : e[r].transform[t], e[r].transform[t] = void 0 === e[r].transform[t] ? i.transform[t] : e[r].transform[t]);
        }

        for (var o = 1; o <= 4; o++) {
          for (t in i[a[o]]) {
            i[a[o]].hasOwnProperty(t) && (e[r][a[o]] = void 0 === e[r][a[o]] ? {} : e[r][a[o]], i[a[o]][t] = void 0 === e[r][a[o]][t] ? "frame_0" === r ? window.rdF0[a[o]][t] : "frame_1" === r ? window.rdF1[a[o]][t] : i[a[o]][t] : e[r][a[o]][t], e[r][a[o]][t] = void 0 === e[r][a[o]][t] ? i[a[o]][t] : e[r][a[o]][t]);
          }
        }
      }
    }
    ...
    var r = window.getComputedStyle(e[0], null),
        ...
        d = 0;
    o.basealign = void 0 === o.basealign ? "grid" : o.basealign, o._isnotext || (o.fontSize = i.revToResp(n ? void 0 === l.fontsize ? _parseInt(s.css("fontSize"), 0) || 20 : l.fontsize : void 0 === o.fontsize ? "rekursive" !== t ? 20 : "inherit" : o.fontsize, i[a].rle), o.fontWeight = i.revToResp(n ? void 0 === l.fontweight ? s.css("fontWeight") || "inherit" : l.fontweight : void 0 === o.fontweight ? e.css("fontWeight") || "inherit" : o.fontweight, i[a].rle), o.whiteSpace = i.revToResp(n ? void 0 === l.whitespace ? "nowrap" : l.whitespace : void 0 === o.whitespace ? "nowrap" : o.whitespace, i[a].rle), o.textAlign = i.revToResp(n ? void 0 === l.textalign ? "left" : l.textalign : void 0 === o.textalign ? "left" : o.textalign, i[a].rle), o.letterSpacing = i.revToResp(n ? void 0 === l.letterspacing ? _parseInt(s.css("letterSpacing"), 0) || "inherit" : l.letterspacing : void 0 === o.letterspacing ? _parseInt(e.css("letterSpacing"), 0) || "inherit" : o.letterspacing, i[a].rle), o.textDecoration = n ? void 0 === l.textDecoration ? "none" : l.textDecoration : void 0 === o.textDecoration ? "none" : o.textDecoration, d = 25, d = void 0 !== s && "I" === e[0].tagName ? "inherit" : d, void 0 !== o.tshadow && (o.tshadow.b = i.revToResp(o.tshadow.b, i[a].rle), o.tshadow.h = i.revToResp(o.tshadow.h, i[a].rle), o.tshadow.v = i.revToResp(o.tshadow.v, i[a].rle))), void 0 !== o.bshadow && (o.bshadow.b = i.revToResp(o.bshadow.b, i[a].rle), o.bshadow.h = i.revToResp(o.bshadow.h, i[a].rle), o.bshadow.v = i.revToResp(o.bshadow.v, i[a].rle), o.bshadow.s = i.revToResp(o.bshadow.s, i[a].rle)), o.display = n ? void 0 === l.display ? s.css("display") : l.display : void 0 === o.display ? e.css("display") : o.display, o["float"] = i.revToResp(n ? void 0 === l["float"] ? s.css("float") || "none" : l["float"] : void 0 === o["float"] ? "none" : o["float"], i[a].rle), o.clear = i.revToResp(n ? void 0 === l.clear ? s.css("clear") || "none" : l.clear : void 0 === o.clear ? "none" : o.clear, i[a].rle), o.lineHeight = i.revToResp(e.is("img") || -1 != jQuery.inArray(o.layertype, ["video", "image", "audio"]) ? d : n ? void 0 === l.lineheight ? _parseInt(s.css("lineHeight"), 0) || d : l.lineheight : void 0 === o.lineheight ? d : o.lineheight, i[a].rle), o.zIndex = n ? void 0 === l.zindex ? _parseInt(s.css("zIndex"), 0) || "inherit" : l.zindex : void 0 === o.zindex ? _parseInt(e.css("zIndex"), 0) || "inherit" : o.zindex, o.paddingTop = i.revToResp(void 0 === o.paddingtop ? _parseInt(r.paddingTop, 0) || 0 : o.paddingtop, i[a].rle), o.paddingBottom = i.revToResp(void 0 === o.paddingbottom ? _parseInt(r.paddingBottom, 0) || 0 : o.paddingbottom, i[a].rle), o.paddingLeft = i.revToResp(void 0 === o.paddingleft ? _parseInt(r.paddingLeft, 0) || 0 : o.paddingleft, i[a].rle), o.paddingRight = i.revToResp(void 0 === o.paddingright ? _parseInt(r.paddingRight, 0) || 0 : o.paddingright, i[a].rle), o.marginTop = i.revToResp(void 0 === o.margintop ? _parseInt(r.marginTop, 0) || 0 : o.margintop, i[a].rle), o.marginBottom = i.revToResp(void 0 === o.marginbottom ? _parseInt(r.marginBottom, 0) || 0 : o.marginbottom, i[a].rle), o.marginLeft = i.revToResp(void 0 === o.marginleft ? _parseInt(r.marginLeft, 0) || 0 : o.marginleft, i[a].rle), o.marginRight = i.revToResp(void 0 === o.marginright ? _parseInt(r.marginRight, 0) || 0 : o.marginright, i[a].rle), o.borderTopWidth = void 0 === o.borderwidth ? _parseInt(r.borderTopWidth, 0) || 0 : o.borderwidth[0], o.borderBottomWidth = void 0 === o.borderwidth ? _parseInt(r.borderBottomWidth, 0) || 0 : o.borderwidth[2], o.borderLeftWidth = void 0 === o.borderwidth ? _parseInt(r.borderLeftWidth, 0) || 0 : o.borderwidth[3], o.borderRightWidth = void 0 === o.borderwidth ? _parseInt(r.borderRightWidth, 0) || 0 : o.borderwidth[1], o.borderTopLeftRadius = i.revToResp(void 0 === o.borderradius ? r.borderTopLeftRadius || 0 : o.borderradius[0], i[a].rle), o.borderTopRightRadius = i.revToResp(void 0 === o.borderradius ? r.borderTopRightRadius || 0 : o.borderradius[1], i[a].rle), o.borderBottomLeftRadius = i.revToResp(void 0 === o.borderradius ? r.borderBottomLeftRadius || 0 : o.borderradius[3], i[a].rle), o.borderBottomRightRadius = i.revToResp(void 0 === o.borderradius ? r.borderBottomRightRadius || 0 : o.borderradius[2], i[a].rle), o.borderStyle = i.revToResp(void 0 === o.borderstyle ? r.borderStyle || 0 : o.borderstyle, i[a].rle), o.borderBottomColor = void 0 === o.bordercolor ? r["border-bottom-color"] : o.bordercolor, o.borderTopColor = void 0 === o.bordercolor ? r["border-top-color"] : o.bordercolor, o.borderLeftColor = void 0 === o.bordercolor ? r["border-left-color"] : o.bordercolor, o.borderRightColor = void 0 === o.bordercolor ? r["border-right-color"] : o.bordercolor, "rekursive" !== t ? (o.color = i.revToResp(void 0 === o.color ? "#ffffff" : o.color, i[a].rle, void 0, "||"), o.minWidth = i.revToResp(void 0 === o.minwidth ? _parseInt(r.minWidth, 0) || 0 : o.minwidth, i[a].rle), o.minHeight = i.revToResp(void 0 === o.minheight ? _parseInt(r.minHeight, 0) || 0 : o.minheight, i[a].rle), o.width = i.revToResp(void 0 === o.width ? "auto" : i.smartConvertDivs(o.width), i[a].rle), o.height = i.revToResp(void 0 === o.height ? "auto" : i.smartConvertDivs(o.height), i[a].rle), o.maxWidth = i.revToResp(void 0 === o.maxwidth ? _parseInt(r.maxWidth, 0) || "none" : o.maxwidth, i[a].rle), o.maxHeight = i.revToResp(-1 !== jQuery.inArray(o.type, ["column", "row"]) ? "none" : void 0 !== o.maxheight ? _parseInt(r.maxHeight, 0) || "none" : o.maxheight, i[a].rle)) : "html" === o.layertype && (o.width = i.revToResp(e[0].width, i[a].rle), o.height = i.revToResp(e[0].height, i[a].rle)), o.styleProps = {
    ...
    if (void 0 !== e) {
      ...
      var a = i[t].level,
        ...
        lineHeight: void 0 === r.basealign ? "inherit" : _parseInt(r.lineHeight[a]),
        ...
        paddingBottom: _parseInt(r.paddingBottom[a]),
        paddingLeft: _parseInt(r.paddingLeft[a]),
        paddingRight: _parseInt(r.paddingRight[a]),
        marginTop: _parseInt(r.marginTop[a]),
        marginBottom: _parseInt(r.marginBottom[a]),
        marginLeft: _parseInt(r.marginLeft[a]),
        marginRight: _parseInt(r.marginRight[a]),
        borderTopWidth: _parseInt(r.borderTopWidth),
        borderBottomWidth: _parseInt(r.borderBottomWidth),
        borderLeftWidth: _parseInt(r.borderLeftWidth),
        borderRightWidth: _parseInt(r.borderRightWidth),
      ...
      return o.borderTopColor = r.borderTopColor, o.borderBottomColor = r.borderBottomColor, o.borderLeftColor = r.borderLeftColor, o.borderRightColor = r.borderRightColor, r._isnotext || (o.textDecoration = r.textDecoration, o.fontSize = _parseInt(r.fontSize[a]), o.fontWeight = _parseInt(r.fontWeight[a]), o.letterSpacing = _parseInt(r.letterSpacing[a]) || 0, o.textAlign = r.textAlign[a], o.whiteSpace = r.whiteSpace[a], o.whiteSpace = "normal" === o.whiteSpace && "auto" === o.width && !0 !== r._incolumn ? "nowrap" : o.whiteSpace, o.display = r.display, void 0 !== r.tshadow && (o.textShadow = _parseInt(r.tshadow.h[a], 0) + "px " + _parseInt(r.tshadow.v[a], 0) + "px " + r.tshadow.b[a] + " " + r.tshadow.c)), void 0 !== r.bshadow && (o.boxShadow = _parseInt(r.bshadow.h[a], 0) + "px " + _parseInt(r.bshadow.v[a], 0) + "px " + _parseInt(r.bshadow.b[a], 0) + "px " + _parseInt(r.bshadow.s[a], 0) + "px " + r.bshadow.c), o;
    }
  },
      L = function L(e, t, i, a, r) {
    var o = jQuery.isNumeric(e) || void 0 === e ? "" : e.indexOf("px") >= 0 ? "px" : e.indexOf("%") >= 0 ? "%" : "";
    return e = jQuery.isNumeric(_parseInt(e)) ? _parseInt(e) : e, e = null == (e = "full" === (e = jQuery.isNumeric(e) ? e * t + o : e) ? a : "auto" === e || "none" === e ? i : e) ? r : e;
  },
      R = function R(e, t, a, r) {
    var o = i[t]._L[e[0].id];
    o = void 0 === o ? {} : o;
    var s = e[0].className;
    ...
    if ("column" === o.type && punchgs.TweenMax.set(o._column, {
      ...
      if (o._incolumn || (f.marginTop = "row" === o.type ? 0 : g.t * h + "px", f.marginBottom = "row" === o.type ? 0 : g.b * h + "px", f.marginLeft = "row" === o.type ? 0 : g.l * u + "px", f.marginRight = "row" === o.type ? 0 : g.r * u + "px"), void 0 !== o.spike && (f["clip-path"] = f["-webkit-clip-path"] = o.spike), p.boxShadow && (f.boxShadow = p.boxShadow), "column" !== o.type && (void 0 !== p.borderStyle && "none" !== p.borderStyle && (0 !== p.borderTopWidth || p.borderBottomWidth > 0 || p.borderLeftWidth > 0 || p.borderRightWidth > 0) ? (f.borderTopWidth = Math.round(p.borderTopWidth * h) + "px", f.borderBottomWidth = Math.round(p.borderBottomWidth * h) + "px", f.borderLeftWidth = Math.round(p.borderLeftWidth * u) + "px", f.borderRightWidth = Math.round(p.borderRightWidth * u) + "px", f.borderStyle = p.borderStyle, f.borderTopColor = p.borderTopColor, f.borderBottomColor = p.borderBottomColor, f.borderLeftColor = p.borderLeftColor, f.borderRightColor = p.borderRightColor) : ("none" === p.borderStyle && (f.borderStyle = "none"), f.borderTopColor = p.borderTopColor, f.borderBottomColor = p.borderBottomColor, f.borderLeftColor = p.borderLeftColor, f.borderRightColor = p.borderRightColor)), "shape" !== o.type && "image" !== o.type || 0 === p.borderTopLeftRadius && 0 === p.borderTopRightRadius && 0 === p.borderBottomLeftRadius && 0 === p.borderBottomRightRadius || (f.overflow = "hidden"), o._isnotext || (f.fontSize = Math.round(p.fontSize * u) + "px", f.fontWeight = p.fontWeight, f.letterSpacing = p.letterSpacing * u + "px", f.lineHeight = Math.round(p.lineHeight * h) + "px", f.textAlign = p.textAlign, p.textShadow && (f.textShadow = p.textShadow)), "column" === o.type && (void 0 === o.cbg_set && (o.cbg_set = o.styleProps["background-color"], o.cbg_set = "" == o.cbg_set || void 0 === o.cbg_set || 0 == o.cbg_set.length ? "transparent" : o.cbg_set, o.cbg_img = e.css("backgroundImage"), o.cbg_img_r = e.css("backgroundRepeat"), o.cbg_img_p = e.css("backgroundPosition"), o.cbg_img_s = e.css("backgroundSize"), o.cbg_o = o.bgopacity ? 1 : o.bgopacity, punchgs.TweenMax.set(e, {
        ...
        backgroundImage: ""
      })), f.backgroundColor = "transparent", f.backgroundImage = "none"), o._isstatic && o.elementHovered && (n = e.data("frames")) && n.frame_hover && n.frame_hover.transform) for (l in f) {
        f.hasOwnProperty(l) && n.frame_hover.transform.hasOwnProperty(l) && delete f[l];
      }

      if ("IFRAME" == e[0].nodeName && "html" === e[0].dataset.layertype && (d = "slide" == p.basealign ? i[t].ulw : i[t].gridwidth[i[t].level], c = "slide" == p.basealign ? i[t].ulh : i[t].gridheight[i[t].level], f.width = !jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.width : d * _parseInt(p.width, 0) / 100 : L(p.width, u, "auto", d, "auto"), f.height = !jQuery.isNumeric(p.height) && p.height.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.height : c * _parseInt(p.height, 0) / 100 : L(p.height, h, "auto", d, "auto")), punchgs.TweenMax.set(e, f), "rekursive" != a) {
        d = "slide" == p.basealign ? i[t].ulw : i[t].gridwidth[i[t].level], c = "slide" == p.basealign ? i[t].ulh : i[t].gridheight[i[t].level];
        var m = !jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.width : d * _parseInt(p.width, 0) / 100 : L(p.width, u, "auto", d, "auto"),
            v = !jQuery.isNumeric(p.height) && p.height.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.height : c * _parseInt(p.height, 0) / 100 : L(p.height, h, "auto", d, "auto"),
            y = {
    ...
    return "polygon(" + z(t.l, 0, _parseFloat(t.lw)) + "," + z(t.r, 100, 100 - _parseFloat(t.rw), !0) + ")";
  },
      z = function z(e, t, i, a) {
    var r;
  ...
  jQuery.extend(!0, t, {
      ...
      if (void 0 !== t[e] && t[e].navigation.use && (t[e].navigation && t[e].navigation.bullets.enable || t[e].navigation && t[e].navigation.tabs.enable || t[e].navigation && t[e].navigation.thumbnails.enable)) {
        ...
        if (r.pause(), a = a > 1 ? 1 : a < 0 ? 0 : a, p(s) && (i || s.width > s.min_width) && o(a, r, t[e].c, s, t[e].slideamount, "tab"), p(n) && (i || n.width > n.min_width) && o(a, r, t[e].c, n, t[e].slideamount, "thumb"), p(l) && i) {
          ...
          d.find(".tp-bullet").each(function (e) {
            var t = jQuery(this),
                i = e + 1,
                a = t.outerWidth() + _parseInt(void 0 === l.space ? 0 : l.space, 0),
                r = t.outerHeight() + _parseInt(void 0 === l.space ? 0 : l.space, 0);
    ...
    manageNavigation: function manageNavigation(e, i) {
      if (t[e].navigation.use) {
        ...
        p(t[e].navigation.bullets) && ("fullscreen" != t[e].sliderLayout && "fullwidth" != t[e].sliderLayout && (t[e].navigation.bullets.h_offset_old = void 0 === t[e].navigation.bullets.h_offset_old ? _parseInt(t[e].navigation.bullets.h_offset, 0) : t[e].navigation.bullets.h_offset_old, t[e].navigation.bullets.h_offset = "center" === t[e].navigation.bullets.h_align ? t[e].navigation.bullets.h_offset_old + a / 2 - o / 2 : t[e].navigation.bullets.h_offset_old + a - o), b(t[e].c.find(".tp-bullets"), t[e].navigation.bullets, e)), p(t[e].navigation.thumbnails) && b(t[e].navigation.thumbnails.c, t[e].navigation.thumbnails, e), p(t[e].navigation.tabs) && b(t[e].navigation.tabs.c, t[e].navigation.tabs, e), p(t[e].navigation.arrows) && ("fullscreen" != t[e].sliderLayout && "fullwidth" != t[e].sliderLayout && (t[e].navigation.arrows.left.h_offset_old = void 0 === t[e].navigation.arrows.left.h_offset_old ? _parseInt(t[e].navigation.arrows.left.h_offset, 0) : t[e].navigation.arrows.left.h_offset_old, t[e].navigation.arrows.left.h_offset = "right" === t[e].navigation.arrows.left.h_align ? t[e].navigation.arrows.left.h_offset_old + o : t[e].navigation.arrows.left.h_offset_old + a, t[e].navigation.arrows.right.h_offset_old = void 0 === t[e].navigation.arrows.right.h_offset_old ? _parseInt(t[e].navigation.arrows.right.h_offset, 0) : t[e].navigation.arrows.right.h_offset_old, t[e].navigation.arrows.right.h_offset = "right" === t[e].navigation.arrows.right.h_align ? t[e].navigation.arrows.right.h_offset_old + o : t[e].navigation.arrows.right.h_offset_old + a), b(t[e].c.find(".tp-leftarrow.tparrows"), t[e].navigation.arrows.left, e), b(t[e].c.find(".tp-rightarrow.tparrows"), t[e].navigation.arrows.right, e)), !1 !== i && (p(t[e].navigation.thumbnails) && r(t[e].navigation.thumbnails, e), p(t[e].navigation.tabs) && r(t[e].navigation.tabs, e));
      }
    },
  ...
  var r = function r(e, i) {
    ...
    s > 2 && (c = l - (p + a) <= 0 ? l - (p + a) < 0 - a ? p : c + a : c, c = l - a + p + r < a && l + (Math.round(s) - 2) * a < p ? l + (Math.round(s) - 2) * a : c), c = "vertical" !== e.direction && e.mask.width() >= e.wrap.width() || "vertical" === e.direction && e.mask.height() >= e.wrap.height() ? 0 : c < 0 - (d - n) ? 0 - (d - n) : c > 0 ? 0 : c, e.c.hasClass("dragged") || ("vertical" === e.direction ? e.wrap.data("tmmove", punchgs.TweenLite.to(e.wrap, .5, {
      ...
      o = function o(e, t, i, a, r, _o) {
    var s = i.parent().find(".tp-" + _o + "s"),
        n = s.find(".tp-" + _o + "s-inner-wrapper"),
        l = s.find(".tp-" + _o + "-mask"),
    ...
    return g && jQuery.each(g, function (e, i) {
      "vertical" === a.direction ? t.add(punchgs.TweenLite.set(i, {
        top: e * (c + _parseInt(void 0 === a.space ? 0 : a.space, 0)),
        width: d + "px",
        height: c + "px"
      })) : "horizontal" === a.direction && t.add(punchgs.TweenLite.set(i, {
        left: e * (d + _parseInt(void 0 === a.space ? 0 : a.space, 0)),
        width: d + "px",
        height: c + "px"
      }));
    }), t;
    ...
    n = "swipebased" == r && "vertical" == d ? "none" : r ? "vertical" : n, jQuery.fn.swipetp || (jQuery.fn.swipetp = jQuery.fn.swipe), jQuery.fn.swipetp.defaults && jQuery.fn.swipetp.defaults.excludedElements || jQuery.fn.swipetp.defaults || (jQuery.fn.swipetp.defaults = {}), jQuery.fn.swipetp.defaults.excludedElements = "label, button, input, select, textarea, .noSwipe", s.swipetp({
      ...
      swipeStatus: function swipeStatus(r, s, n, c, p, u, h) {
        ...
        if ("carousel" === t[a].sliderType && (("move" === s || "end" === s || "cancel" == s) && t[a].dragStartedOverSlider && !t[a].dragStartedOverThumbs && !t[a].dragStartedOverTabs || "start" === s && g > 0 && 0 === f && 0 === m)) {
          ...
          var T = e.parent().find(w),
              ...
              M = void 0 === L.data("offset") ? 0 : _parseInt(L.data("offset"), 0),
              O = 0;
          ...
          switch (s) {
            ...
            case "move":
              ...
              var C = "vertical" === R ? 0 - (L.height() - T.height()) : 0 - (L.width() - T.width());
              O = O < C ? "horizontal" === R ? O + L.width() * (O - C) / L.width() * (O - C) / L.width() : O + L.height() * (O - C) / L.height() * (O - C) / L.height() : O, "vertical" === R ? punchgs.TweenLite.set(L, {
                top: O + "px"
      ...
      c = function c(e) {
    e.hide_delay = jQuery.isNumeric(_parseInt(e.hide_delay, 0)) ? e.hide_delay : .2, e.hide_delay_mobile = jQuery.isNumeric(_parseInt(e.hide_delay_mobile, 0)) ? e.hide_delay_mobile : .2;
  },
      p = function p(e) {
    return e && e.enable;
  },
    ...
    for (var a in i) {
      i.hasOwnProperty(a) && p(t[e].navigation[i[a]]) && (u(t[e].navigation[i[a]].showCall), t[e].navigation[i[a]].showCall = setTimeout(function (i) {
        u(i.hideCall), i.hide_onleave && !t[e].cpar.hasClass("tp-mouseover") || (void 0 === i.tween ? i.tween = f(i) : i.tween.play());
      }, t[e].navigation[i[a]].hide_onleave && !t[e].cpar.hasClass("tp-mouseover") ? 0 : _parseInt(t[e].navigation[i[a]].animDelay), t[e].navigation[i[a]]));
    }
  },
      g = function g(e, a) {
    ...
    for (var o in r) {
      r.hasOwnProperty(o) && void 0 !== t[e].navigation[r[o]] && t[e].navigation[r[o]].hide_onleave && p(t[e].navigation[r[o]]) && (u(t[e].navigation[r[o]].hideCall), t[e].navigation[r[o]].hideCall = setTimeout(function (e) {
        u(e.showCall), e.tween && e.tween.reverse();
      }, i ? _parseInt(t[e].navigation[r[o]].hide_delay_mobile, 0) : _parseInt(t[e].navigation[r[o]].hide_delay, 0), t[e].navigation[r[o]]));
    }
  },
      f = function f(e) {
    ...
    e.rtl ? (a.click(function () {
      ...
      "carousel" === t[i].sliderType && (t[i].ctNavElement = !0), t[i].sc_indicator = "arrow", t[i].sc_indicator_dir = 1, t[i].c.revprev();
    })), e.right.j = t[i].c.find(".tp-rightarrow.tparrows"), e.left.j = t[i].c.find(".tp-leftarrow.tparrows"), e.padding_top = _parseInt(t[i].carousel.padding_top || 0, 0), e.padding_bottom = _parseInt(t[i].carousel.padding_bottom || 0, 0), b(a, e.left, i), b(r, e.right, i), "outer-left" != e.position && "outer-right" != e.position || (t[i].outernav = !0);
  },
      v = function v(e, i, a) {
    ...
    if (v(e, i, a), y(e, i, a), "outer-left" === i.position && r ? punchgs.TweenLite.set(e, {
      ...
      var n = e.data("wr_padding"),
          ...
          p = _parseInt(i.padding_top || 0, 0),
          u = _parseInt(i.padding_bottom || 0, 0),
          h = {},
          g = {};
    ...
    var l = e.find(".justaddedbullet"),
        ...
        c = l.outerWidth() + _parseInt(void 0 === i.space ? 0 : i.space, 0),
        p = l.outerHeight() + _parseInt(void 0 === i.space ? 0 : i.space, 0);
    ...
    }), l.removeClass("justaddedbullet"), i.padding_top = _parseInt(t[r].carousel.padding_top || 0, 0), i.padding_bottom = _parseInt(t[r].carousel.padding_bottom || 0, 0), "outer-left" != i.position && "outer-right" != i.position || (t[r].outernav = !0), o.addClass("nav-pos-hor-" + i.h_align), o.addClass("nav-pos-ver-" + i.v_align), o.addClass("nav-dir-" + i.direction), b(o, i, r);
  },
      _ = function _(e, i, a, r, o) {
    ...
    if (i.visibleAmount = i.visibleAmount > t[o].slideamount ? t[o].slideamount : i.visibleAmount, i.sliderLayout = t[o].sliderLayout, 0 === e.parent().find(s).length) {
      ...
      "outer-top" === i.position ? e.parent().prepend(u) : "outer-bottom" === i.position ? e.after(u) : e.append(u), "outer-left" !== i.position && "outer-right" !== i.position || punchgs.TweenLite.set(t[o].c, {
        overflow: "visible"
      }), i.padding_top = _parseInt(t[o].carousel.padding_top || 0, 0), i.padding_bottom = _parseInt(t[o].carousel.padding_bottom || 0, 0), "outer-left" != i.position && "outer-right" != i.position || (t[o].outernav = !0);
    }
    ...
    var _ = g.find(".justaddedthumb"),
        x = g.find(d).length,
        k = _.outerWidth() + _parseInt(void 0 === i.space ? 0 : i.space, 0),
        T = _.outerHeight() + _parseInt(void 0 === i.space ? 0 : i.space, 0);
  ...
  var t = jQuery.fn.revolution;
  jQuery.extend(!0, t, {
    stopPanZoom: function stopPanZoom(e) {
      null != e.data("pztl") && e.data("pztl").pause();
    },
    startPanZoom: function startPanZoom(e, i, a) {
      var r = e.data(),
          o = e.find("rs-sbg"),
      ...
      if (void 0 !== r.panzoom && null !== r.panzoom) {
        ...
        var c = function c(e, t, i, a, r, o, s) {
          var n = e * i,
              l = t * i,
              d = Math.abs(a - n),
              c = Math.abs(r - l),
        ...
        var p = e.data("pzimg"),
            ...
            for (var a in t) {
              if (t.hasOwnProperty(a)) {
                ...
                switch (o) {
                  ...
                  case "ss":
                    i.scalestart = _parseInt(s, 0) / 100;
                    break;

                  case "se":
                    i.scaleend = _parseInt(s, 0) / 100;
                    break;

                  case "rs":
                    i.rotatestart = _parseInt(s, 0);
                    break;

                  case "re":
                    i.rotateend = _parseInt(s, 0);
                    break;

                  case "bs":
                    i.blurstart = _parseInt(s, 0);
                    break;

                  case "be":
                    i.blurend = _parseInt(s, 0);
                    break;
          ...
          var l = function (e, t, i, a) {
            ...
            o = _parseInt(o, 0) / 100 || 0, s = _parseInt(s, 0) / 100 || 0;
            var n = new Object();
          ...
          r[0] = _parseFloat(r[0]) + l.start.l, o[0] = _parseFloat(o[0]) + l.end.l, r[1] = _parseFloat(r[1]) + l.start.t, o[1] = _parseFloat(o[1]) + l.end.t;
  ...
  jQuery.extend(!0, t, {
    checkForParallax: function checkForParallax(e) {
      ...
      if (!a.done) {
        ...
        t[e].slides.each(function () {
          ...
          width: "100%",
          height: "100%"
        }), n(t[e].c.find("rs-static-layers"))), a.pcontainers = [], a.pcontainer_depths = [], a.bgcontainers = [], a.bgcontainer_depths = [], a.speed = void 0 === a.speed ? 0 : _parseInt(a.speed, 0), a.speedbg = void 0 === a.speedbg ? 0 : _parseInt(a.speedbg, 0), a.speedls = void 0 === a.speedls ? 0 : _parseInt(a.speedls, 0), t[e].c.find("rs-slide rs-sbg-wrap, rs-slide rs-bgvideo").each(function () {
          var i = jQuery(this),
              r = i.data("parallax");
          void 0 !== (r = "on" == r || !0 === r ? 1 : r) && "off" !== r && !1 !== r && (a.bgcontainers.push(i.closest("rs-sbg-px")), a.bgcontainer_depths.push(t[e].parallax.levels[_parseInt(r, 0) - 1] / 100));
        });
        ...
        "mouse" != a.type && "mousescroll" != a.type && "3D" != a.type && "3d" != a.type || (t[e].c.mouseenter(function (i) {
          ...
          if (s.find(".tp-parallax-container").each(function (e) {
            ...
            var e = jQuery(this),
                t = _parseInt(e.data("parallaxlevel"), 0) / 100,
                i = c * t * 2,
                a = p * t * 4;
        ...
        s.set && (s.multiplicator_layers = _parseFloat(s.multiplicator_layers), s.multiplicator = _parseFloat(s.multiplicator)), void 0 !== s._L && 0 === s._L.length && (s._L = !1), void 0 !== s.bgs && 0 === s.bgs.length && (s.bgs = !1), t.scrollTicker(e);
      }
    ...
    scrollHandling: function scrollHandling(e, a, r, o) {
      if (void 0 !== t[e]) {
        ...
        if ("3d" != l.type && "3D" != l.type) {
          if (("scroll" == l.type || "mousescroll" == l.type) && l.pcontainers) for (var f = 0; f < l.pcontainers.length; f++) {
  ...
  var t = jQuery.fn.revolution;
  jQuery.extend(!0, t, {
    animateSlide: function animateSlide(e) {
      return a(e);
    }
  });
  ...
  var i = function i(e, t) {
    var i;
    return void 0 !== (i = jQuery.isArray(e) ? e.length >= t ? e[t] : e[e.length - 1] : e) && jQuery.isNumeric(i) ? _parseInt(e, 0) : i;
  },
      a = function a(e) {
    var a = e.id,
    ...
    if (u = "default" === u || "d" === u ? s.TR[8] || punchgs.Power2.easeInOut : u || s.TR[8] || punchgs.Power2.easeInOut, h = "default" === h || "d" === h ? s.TR[9] || punchgs.Power2.easeInOut : h || s.TR[9] || punchgs.Power2.easeInOut, 0 == n) {
    ...
    });else if (9 == n || 10 == n) for (var y = t[a].pr_next_bg[0].getElementsByClassName("slotslide"), b = d - d / 1.8, w = 0; w < y.length; w++) {
      ...
      P = 19 === n ? "center center -" + t[a].height / 2 : 22 === n ? "center center " + t[a].height / 2 : 23 === n ? "center center -" + t[a].width / 2 : "center center " + t[a].width / 2;
      ...
      P = 1 === o ? "20% " : "80% ";
      P += "60% -50%", t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 1e3, {
        ...
        delay: 0,
        ease: u
      }), 0), P = 1 != o ? "20% " : "80% ", P += "60% -50%", t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, {
        autoAlpha: 1,
        rotationX: 0,
        top: 0,
        z: 0,
      ...
      P = 1 === o ? 25 === n ? "center top 0" : "left center 0" : 25 === n ? "center bottom 0" : "right center 0";
      t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 1e3, {
        transformStyle: "flat",
        rotationX: A,
        top: 0,
        ...
        rotationY: 0,
        ease: u
      }), 0), P = 1 === o ? 25 === n ? "center bottom 0" : "right center 0" : 25 === n ? "center top 0" : "left center 0", j = 25 !== n ? -j : j, A = 25 !== n ? A : -A, t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, {
        rotationX: 0,
        rotationY: 0,
        transformStyle: "flat",
        transformPerspective: 1200,
      ...
      V[G] = "0px", Y[G] = H, F[G] = W, E[G] = "0%", X[G] = N, Z[G] = H, q[G] = D, U[G] = B, Q.append('<span style="background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, V, Y), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg.find("rs-sbg"), d / 2e3, F, E), d / 2e3), t[a].mtl.add(punchgs.TweenLite.fromTo(Q, d / 1e3, X, Z), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(Q.find(".slotslide div"), d / 1e3, q, U), 0);
    }
  },
      r = function r(e, i, a, _r2) {
    var o = e.find("rs-sbg"),
        s = o.data("mediafilter"),
        n = e.data("zoomstart"),
        l = e.data("rotationstart");
    null != o.data("currotate") && (l = o.data("currotate")), null != o.data("curscale") && "box" == _r2 ? n = 100 * o.data("curscale") : null != o.data("curscale") && (n = o.data("curscale")), function (e, i) {
    ...
    if (u = null == u ? 0 : u, e.find(".slot").each(function () {
      jQuery(this).remove();
    }), "box" === _r2) for (var w = 0, _ = 0, x = 0; x < t[i].slots; x++) {
      _ = 0;
  ...
  function a(e) {
    return null == e ? -1 : jQuery.isNumeric(e) ? e : e.split(":").length > 1 ? 60 * _parseInt(e.split(":")[0], 0) + _parseInt(e.split(":")[1], 0) : e;
  }
  ...
  jQuery.extend(!0, t, {
    ...
    resetVideo: function resetVideo(e, a, r, o) {
    ...
    Mute: function Mute(e, i, a) {
      ...
      switch (o.type) {
        case "youtube":
          o.player && (!0 === a && o.player.mute(), !1 === a && l(o, _parseInt(o.volcache, 0)), r = o.player.isMuted());
          break;
    ...
    stopVideo: function stopVideo(e, i) {
      ...
      switch (clearTimeout(a.videoplaywait), a.type) {
        ...
        case "vimeo":
          0 == e.find("iframe").length ? (delete a.vimeoplayer, e.append(a.videomarkup), h(e, i, !0)) : e.hasClass("rs-apiready") ? (a.vimeoplayer = null == a.vimeoplayer ? new Vimeo.Player(e.find("iframe").attr("id")) : a.vimeoplayer, a.vimeoplayer.getPaused() ? setTimeout(function () {
            ...
            a.nseTriggered && (r = -1, a.nseTriggered = !1), -1 != a.ssec && a.ssec > r && a.vimeoplayer.setCurrentTime(a.ssec), ("mute" == a.volume || 0 === a.volume || t.lastToggleState(e.data("videomutetoggledby")) || !0 === t[i].globalmute) && a.vimeoplayer.setVolume(0), c(a.vimeoplayer);
    ...
    prepareCoveredVideo: function prepareCoveredVideo(e, i) {
    ...
    manageVideoLayer: function manageVideoLayer(e, a) {
      ...
      if (o.audio = void 0 !== o.audio && o.audio, i && o.opom) 0 == e.find("rs-poster").length && e.append('<rs-poster class="noSwipe" style="background-image:url(' + o.poster + ');"></rs-poster>');else {
        switch (o.id = e[0].id, o.pload = "auto" === o.pload || "canplay" === o.pload || "canplaythrough" === o.pload || "progress" === o.pload ? "auto" : o.pload, o.type = null != o.mp4 || null != o.webm ? "html5" : null != o.ytid && String(o.ytid).length > 1 ? "youtube" : null != o.vimeoid && String(o.vimeoid).length > 1 ? "vimeo" : "none", o.newtype = "html5" == o.type && 0 == e.find(o.audio ? "audio" : "video").length ? "html5" : "youtube" == o.type && 0 == e.find("iframe").length ? "youtube" : "vimeo" == o.type && 0 == e.find("iframe").length ? "vimeo" : "none", !o.audio && "1sttime" == o.aplay && o.pausetimer && o.bgvideo && e.closest("rs-slide").addClass("rs-pause-timer-once"), o.audio || !o.bgvideo || !o.pausetimer || 1 != o.aplay && "true" != o.aplay && "no1sttime" != o.aplay || e.closest("rs-slide").addClass("rs-pause-timer-always"), o.noInt && e.addClass("rs-nointeraction"), o.newtype) {
          ...
          case "youtube":
            ...
            o.vatrnew = l.length > 1 ? l[0] + "origin=https://" + (self.location.href.match(/www/gi) && !l[1].match(/www/gi) ? "www." + l[1] : l[1]) : o.vatr, o.videomarkup = '<iframe allow="autoplay; fullscreen" type="text/html" src="https://www.youtube.com/embed/' + o.ytid + "?" + o.vatrnew + '" ' + (!0 === o.afs ? "allowfullscreen" : "") + ' width="100%" height="100%" style="opacity:0;visibility:visible;width:100%;height:100%"></iframe>';
            break;
  ...
  var r = function r(e, t, i) {
    ...
    e.vimeostarted = !0, e.nextslidecalled = !1, punchgs.TweenLite.to(i.find("rs-poster"), .3, {
      ...
      display: "block",
      ease: punchgs.Power3.easeInOut
    }), t[a].c.trigger("revolution.slide.onvideoplay", o(e.vimeoplayer, "vimeo", e)), t[a].stopByVideo = e.pausetimer, b(i, a), "mute" == e.volume || 0 === e.volume || t.lastToggleState(i.data("videomutetoggledby")) || !0 === t[a].globalmute ? e.vimeoplayer.setVolume(0) : n(e, _parseInt(e.volcache, 0) / 100 || .75), t.toggleState(e.videotoggledby);
  },
      h = function h(e, a, r) {
    ...
    if (n.ifr = e.find("iframe"), s(a, e), n.ifr.attr("id", d), n.startvideonow = r, n.videolistenerexist) {
          ...
          events: {
            onStateChange: function onStateChange(i) {
              i.data == YT.PlayerState.PLAYING ? (punchgs.TweenLite.to(e.find("rs-poster"), .3, {
                ...
                display: "block",
                ease: punchgs.Power3.easeInOut
              }), "mute" == n.volume || 0 === n.volume || t.lastToggleState(e.data("videomutetoggledby")) || !0 === t[a].globalmute ? n.player.mute() : l(n, _parseInt(n.volcache, 0) || 75), t[a].stopByVideo = !0, b(e, a), n.pausetimer ? t[a].c.trigger("stoptimer") : t[a].stopByVideo = !1, t[a].c.trigger("revolution.slide.onvideoplay", o(n.player, "youtube", n)), t.toggleState(n.videotoggledby)) : (0 == i.data && n.loop && (-1 != n.ssec && n.player.seekTo(n.ssec), p(n), t.toggleState(n.videotoggledby)), f() || 0 != i.data && 2 != i.data || !(n.scop && e.find("rs-poster").length > 0 || n.bgvideo && e.find(".rs-fullvideo-cover").length > 0) || (n.bgvideo ? punchgs.TweenLite.to(e.find(".rs-fullvideo-cover"), .1, {
                opacity: 1,
                force3D: "auto",
                ease: punchgs.Power3.easeInOut
            ...
            onReady: function onReady(a) {
              ...
              !o && (!t.isSafari11() || o && s) || "RS-BGVIDEO" !== e[0].tagName && (!s || !0 !== n.aplay && "true" !== n.aplay) || (r = !0, n.player.setVolume(0), n.volume = "mute", n.player.mute(), clearTimeout(e.data("mobilevideotimr")), e.data("mobilevideotimr", setTimeout(function () {
                p(n);
              }, 500))), r || "mute" != n.volume || (n.player.setVolume(0), n.player.mute()), e.addClass("rs-apiready"), null == n.speed && 1 === n.speed || a.target.setPlaybackRate(_parseFloat(n.speed)), e.find("rs-poster").unbind("click"), e.find("rs-poster").click(function () {
                i || p(n);
      ...
      case "vimeo":
        for (var h, m = n.ifr.attr("src"), v = {}, y = m, _ = /([^&=]+)=([^&]*)/g; h = _.exec(y);) {
        ...
        if (T && L && (m += "&background=1"), n.ifr.attr("src", m), n.vimeoplayer = void 0 === n.vimeoplayer || !1 === n.vimeoplayer ? new Vimeo.Player(d) : n.vimeoplayer, T) L ? x = !0 : (n.aplay || "true" === n.aplay) && (k && (n.aplay = !1), x = !0), x && (n.vimeoplayer.setVolume(0), n.volume = "mute");
        n.vimeoplayer.on("play", function (t) {
          ...
          }), n.startvideonow && ("mute" === n.volume && n.vimeoplayer.setVolume(0), c(n.vimeoplayer), -1 != n.ssec && n.vimeoplayer.setCurrentTime(n.ssec));
    ...
    n.metaloaded = !0, n.control && !n.audio || (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), e.find("video, rs-poster, .tp-video-play-button").click(function () {
      ...
      n.nextslidecalled = !1, n.volume = null != n.volume && "mute" != n.volume ? _parseFloat(n.volcache) : n.volume, n.volcache = null != n.volcache && "mute" != n.volcache ? _parseFloat(n.volcache) : n.volcache, t.is_mobile() || t.isSafari11() || (!0 === t[a].globalmute ? n.video.muted = !0 : n.video.muted = "mute" == n.volume, n.volcache = jQuery.isNumeric(n.volcache) && n.volcache > 1 ? n.volcache / 100 : n.volcache, "mute" == n.volume ? n.video.muted = !0 : null != n.volcache && (n.video.volume = n.volcache)), e.addClass("videoisplaying"), b(e, a), !0 !== n.pausetimer || "audio" == n.tag ? (t[a].stopByVideo = !1, t[a].c.trigger("revolution.slide.onvideostop", o(n.video, "html5", n))) : (t[a].stopByVideo = !0, t[a].c.trigger("revolution.slide.onvideoplay", o(n.video, "html5", n))), n.pausetimer && "playing" == t[a].sliderstatus && (t[a].stopByVideo = !0, t[a].c.trigger("stoptimer")), punchgs.TweenLite.to(e.find("rs-poster"), .3, {
        opacity: 0,
        visibility: "hidden",
        force3D: "auto",
        ease: punchgs.Power3.easeInOut
