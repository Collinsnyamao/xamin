...
!function (t, e) {
...
}(true ? window : undefined, function () {
  function t() {}
  ...
  var s = document.documentElement.style,
    ...
    transitionDelay: r + "Delay"
      ...
      d = o.prototype = _Object$create(t.prototype);
  ...
  d.constructor = o, d._create = function () {
    ...
    this.position.x = _parseFloat(t), this.position.y = _parseFloat(e);
    ...
    if (!_parseFloat(this.layout.options.transitionDuration)) return void this._nonTransition(t);
    var e = this._transn;
  ...
  return d.removeTransitionStyles = function () {
    ...
    return r && _parseFloat(this.layout.options.transitionDuration) ? (this.once("transitionEnd", function () {
      this.removeElem();
  ...
  function r(t) {
    ...
    return e.prototype = _Object$create(t.prototype), e.prototype.constructor = e, e;
  }
  ...
  var i = e.prototype = _Object$create(t.Item.prototype),
      o = i._create;
  ...
  return n.forEach(function (t) {
    ...
    return n.prototype = _Object$create(o), n.prototype.constructor = n, e && (n.options = e), n.prototype.namespace = t, i.modes[t] = n, n;
  }, i;
}), function (t, e) {
  ...
  d.sortDataParsers = {
    parseInt: function (_parseInt) {
      ...
      return _parseInt2(t, 10);
    }),
    parseFloat: function (_parseFloat2) {
      function parseFloat(_x2) {
        return _parseFloat2.apply(this, arguments);
      }

      parseFloat.toString = function () {
        return _parseFloat2.toString();
      };
