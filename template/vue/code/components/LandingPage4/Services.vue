      ...
      <div class="row iq-how-it-works">
        <div class="col-sm-12 wow fadeInUp">
          ...
          <div class="custom-tab">
            <ul id="pills-tab" class="nav nav-pills mb-5 text-center" role="tablist">
              <li v-for="(tab,index) in tabs" :key="index" class="nav-item">
                ...
                >
                  <img :src="tab.image" alt="tab-image" class="img-fluid" />
            ...
            <div class="show_content">
              <div id="tab-big-data" class="tab-pane fade active show">
                  ...
                  <div class="col-sm-4">
                    <div class="text-left">
                      <ul class="iq-list">
                        ...
                        <li><i class="fas fa-check-square"></i><span>Simply dummy text of the</span></li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="text-left">
                      <ul class="iq-list">
                        ...
                        <li><i class="fas fa-check-square"></i><span>It is a long established fact.</span></li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="text-left">
                      <ul class="iq-list">
                        ...
                        <li><i class="fas fa-check-square"></i><span>will be distracted by the of readable</span></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="row pl-lg-5 pr-lg-5">
                  <div class="col-sm-12">
                    <div class=" text-left mt-4 "><a class="button button-icon" href="#"><span
                      class="btn-effect"> View all Services</span></a></div>
                  </div>
                </div>
              </div>
              <div id="tab-machine-learning" class="tab-pane fade">
                <div class="row pl-lg-5 pr-lg-5">
                  <div class="col-sm-6">
                    ...
                    <div class="text-left mt-4 mb-lg-0 mb-md-0 mb-4">
              ...
              <div id="tab-computer-vision" class="tab-pane fade">
                <div class="row pl-lg-5 pr-lg-5">
                  <div class="col-sm-6">
                    <h4 class="custom_heading mb-2">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                    </h4>
                    <div class="text-left no-margin">
                      <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable.</p>
                    </div>
    ...
    return {
      tabs: [
        ...
        },
        {
          ...
          active: false,
          image: require('../../assets/images/services/04.png')
        }
      ]
    }
  }
