      ...
      <rs-module id="rev_slider_2_1" class=" rs-ov-hidden" style="display:none;" data-version="6.1.0">
        <rs-slides>
          <rs-slide data-key="rs-1" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;" data-firstanim="t:fade;sl:12;">
              <img :src="require('../../static/revslider/assets_slider2/dummy.png')" alt="transparent" :data-lazyload="require('../../static/revslider/assets_slider2/transparent.png')" data-parallax="off" class="rev-slidebg" data-no-retina>
              <rs-bgvideo
