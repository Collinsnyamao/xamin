    ...
    <rs-module id="rev_slider_3_1" class=" rs-ov-hidden" style="display:none;" data-version="6.1.0">
      <rs-slides>
        <rs-slide data-key="rs-3" data-title="Slide" data-anim="ei:d,d,d,d,d,d,d,d,d;eo:d,d,d,d,d,d,d,d,d;s:1000ms,d,d,d,d,d,d,d,d;r:0,0,0,0,0,0,0,0,0;t:fade,grayscale,blurlight,blurstrong,fade,crossfade,fadethroughlight,fadethroughdark,fadethroughtransparent;sl:d,d,d,d,d,d,d,d,d;" data-firstanim="t:fade;sl:12;">
          <img :src="require('../../static/revslider/assets_slider3/dummy.png')" title="bg" width="856" height="500" :data-lazyload="require('../../static/revslider/assets_slider3/bg.png')" data-bg="f:100% 100%;" data-parallax="2" class="rev-slidebg" data-no-retina>
          <h2
          ...
          ><img :src="require('../../static/revslider/assets_slider3/dummy.png')" width="890" height="732" :data-lazyload="require('../../static/revslider/assets_slider3/1.png')" data-no-retina> 
          </rs-layer>
          <rs-layer
          ...
          ><img :src="require('../../static/revslider/assets_slider3/dummy.png')" width="364" height="246" :data-lazyload="require('../../static/revslider/assets_slider3/2.png')" data-no-retina> 
          </rs-layer><rs-layer
          ...
          ><a class="button_link" href="#"><i class="ion-play" aria-hidden="true"></i>Watch Video</a> 
          </rs-layer>
          <rs-layer
          ...
          ><img :src="require('../../static/revslider/assets_slider3/dummy.png')" width="890" height="732" :data-lazyload="require('../../static/revslider/assets_slider3/7.png')" data-no-retina> 
          </rs-layer>
          <rs-layer
          ...
          >
          <img :src="require('../../static/revslider/assets_slider3/dummy.png')" width="261" height="151" :data-lazyload="require('../../static/revslider/assets_slider3/6.png')" data-no-retina> 
          </rs-layer>
          <rs-layer
          ...
          ><img :src="require('../../static/revslider/assets_slider3/dummy.png')" width="387" height="292" :data-lazyload="require('../../static/revslider/assets_slider3/3.png')" data-no-retina> 
          </rs-layer>
          <rs-layer
          ...
          ><img :src="require('../../static/revslider/assets_slider3/dummy.png')" width="206" height="122" :data-lazyload="require('../../static/revslider/assets_slider3/5.png')" data-no-retina> 
          </rs-layer>
        </rs-slide>
      </rs-slides>
      <rs-static-layers>
