<template>
  <rs-module-wrap id="rev_slider_1_1_wrapper" data-alias="xamin" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
    <rs-module id="rev_slider_1_1" class=" rs-ov-hidden" style="display:none;" data-version="6.1.0">
      <rs-slides>
        <rs-slide data-key="rs-6" data-title="Slide" data-anim="ei:d,d,d,d,d,d,d,d,d;eo:d,d,d,d,d,d,d,d,d;s:1000ms,d,d,d,d,d,d,d,d;r:0,0,0,0,0,0,0,0,0;t:fade,grayscale,blurlight,blurstrong,fade,crossfade,fadethroughlight,fadethroughdark,fadethroughtransparent;sl:d,d,d,d,d,d,d,d,d;" data-firstanim="t:fade;sl:12;">
          <img
            src="revslider/assets/dummy.png"
            alt="images"
            title="01"
            width="1600"
            height="758"
            data-lazyload="revslider/assets/01-2.jpg"
            data-parallax="2"
            class="rev-slidebg"
            data-no-retina
          >
...
>Contact Us
          ...
          >
            <img
              ...
              width="445"
              height="445"
              data-lazyload="revslider/assets/01-4.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="824"
              height="818"
              data-lazyload="revslider/assets/10-2.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/03-5.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/08-3.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/07-4.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/05-4.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/06-6.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/04-5.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="300"
              height="200"
              data-lazyload="revslider/assets/09-3.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="200"
              height="200"
              data-lazyload="revslider/assets/02.png"
              data-no-retina
            >
          </rs-layer>
          <!--
          ...
          >
            <img
              ...
              width="172"
              height="169"
              data-lazyload="revslider/assets/11.png"
              data-no-retina
            >
          </rs-layer>
          <!--
