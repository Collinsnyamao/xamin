      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInUp align-items-center">
          ...
          <div class="text-left column-2 mb-5 ">
            <ul class="iq-list">
              <li><i class="ion ion-checkmark-round"></i><span>Boost SEO ranking</span></li>
              <li><i class="ion ion-checkmark-round"></i><span>Social Sharing</span></li>
              <li><i class="ion ion-checkmark-round"></i><span>Marketing</span></li>
              <li><i class="ion ion-checkmark-round"></i><span>Retention</span></li>
              <li><i class="ion ion-checkmark-round"></i><span>Visual Reviews</span></li>
              <li><i class="ion ion-checkmark-round"></i><span>Reviews Generation</span></li>
            </ul>
          </div>
        ...
        <div class="col-lg-6  wow fadeInUp xamin-right-img">
          <img :src="require('../../assets/images/about-us/16.png')" alt="about">
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6  wow fadeInUp xamin-left-img">
          <img :src="require('../../assets/images/about-us/17.png')" alt="about-2">
