      ...
      <rs-module id="rev_slider_5_1" class=" rs-ov-hidden" style="display:none;" data-version="6.1.0">
        <rs-slides>
          <rs-slide data-key="rs-3" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;" data-firstanim="t:fade;sl:12;">
            <img :src="require('../../static/revslider/temp_rev_image/dummy.png')" title="demo5-rev-bg" width="1600" height="896" :data-lazyload="require('../../static/revslider/temp_rev_image/demo5-rev-bg.png')" data-parallax="off" class="rev-slidebg" data-no-retina>
            <!--
              -->
            <rs-layer
            ...
            <rs-layer
              ...
              ><a class="text-center"><i class="ion-social-twitter"></i></a> 
            </rs-layer>
            <!--
              -->
            <rs-layer
              ...
              ><a class="text-center "><i class="ion-social-instagram"></i></a> 
            </rs-layer>
            <!--
              -->
            <rs-layer
              ...
              ><a class="text-center"><i class="ion-social-facebook"></i></a> 
            </rs-layer>
            <!--
              -->
            <rs-layer
